...
namespace Hishop.Components.Validation
{
	public abstract class Validator
	{
		...
		{
			return string.Format(CultureInfo.CurrentCulture, this.MessageTemplate, objectToValidate, key, this.Tag);
		}
	}
	public abstract class Validator<T> : Validator
	{
		...
		protected internal override void DoValidate(object objectToValidate, object currentTarget, string key, ValidationResults validationResults)
		{
			...
			{
				string message = string.Format(CultureInfo.CurrentCulture, Resources.ExceptionInvalidTargetType, typeof(T).FullName, objectToValidate.GetType().FullName);
