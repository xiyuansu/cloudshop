...
namespace Hishop.Components.Validation.Validators
{
	...
	public sealed class DateTimeRangeValidatorAttribute : ValueValidatorAttribute
	{
		...
		public DateTimeRangeValidatorAttribute(string upperBound)
			: this(DateTimeRangeValidatorAttribute.ConvertToISO8601Date(upperBound))
		{
		}
		...
		public DateTimeRangeValidatorAttribute(string lowerBound, string upperBound)
			: this(DateTimeRangeValidatorAttribute.ConvertToISO8601Date(lowerBound), DateTimeRangeValidatorAttribute.ConvertToISO8601Date(upperBound))
		{
		}
		...
		public DateTimeRangeValidatorAttribute(string lowerBound, RangeBoundaryType lowerBoundType, string upperBound, RangeBoundaryType upperBoundType)
			: this(DateTimeRangeValidatorAttribute.ConvertToISO8601Date(lowerBound), lowerBoundType, DateTimeRangeValidatorAttribute.ConvertToISO8601Date(upperBound), upperBoundType)
		{
		}
