...
namespace Hishop.Components.Validation.Validators
{
	public class RangeValidator<T> : ValueValidator<T> where T : IComparable
	{
		...
		public RangeValidator(T lowerBound, RangeBoundaryType lowerBoundType, T upperBound, RangeBoundaryType upperBoundType)
			: this(lowerBound, lowerBoundType, upperBound, upperBoundType, (string)null)
		{
		}

		protected RangeValidator(T lowerBound, RangeBoundaryType lowerBoundType, T upperBound, RangeBoundaryType upperBoundType, bool negated)
			: this(lowerBound, lowerBoundType, upperBound, upperBoundType, (string)null, negated)
		{
		}
		...
		{
			return string.Format(CultureInfo.CurrentCulture, base.MessageTemplate, objectToValidate, key, base.Tag, this.rangeChecker.LowerBound, this.rangeChecker.LowerBoundType, this.rangeChecker.UpperBound, this.rangeChecker.UpperBoundType);
		}
	}
