...
{
	public class Common_SubmmitCartProducts : WAPTemplatedWebControl
	{
		public delegate void DataBindEventHandler(object sender, RepeaterItemEventArgs e);

		public const string TagID = "Common_SubmmitCartProducts";
		...
		public Common_SubmmitCartProducts()
		{
			base.ID = "Common_SubmmitCartProducts";
		}
