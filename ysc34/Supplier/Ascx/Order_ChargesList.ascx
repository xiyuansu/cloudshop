<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Order_ChargesList.ascx.cs" Inherits="Hidistro.UI.Web.Supplier.Order_ChargesList" %>
...
<style>
    ...
    .lblTotalPrice {color:#333;font-weight:700;}
</style>
<table width="300" border="0" cellspacing="0" style="float: right;" class="total_table">
    <tr>
        <td align="right">购物车小计：</td>
        <td>
            <Hi:FormatedMoneyLabel ID="lblTotalPrice" runat="server" CssClass="lblTotalPrice" /></td>
    </tr>
    ...
    <tr id="tdFreight" runat="server">
        ...
        <td style="color:#666;width:180px;" class="text-ellipsis float">
            <asp:Literal ID="litFreight" runat="server" />&nbsp;</td>
    </tr>
    <%--<tr>
    ...
    <tr class="bg" style="border-top:1px solid #ddd;">
        <td align="right" class="colorG">结算价：</td>
