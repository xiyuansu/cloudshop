<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Order_ItemsList.ascx.cs" Inherits="Hidistro.UI.Web.Supplier.Order_ItemsList" %>
...
<asp:Repeater ID="dlstOrderItems" runat="server">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <Hi:FormatedMoneyLabel ID="lblItemListPrice" runat="server" Money='<%# Eval("ItemCostPrice") %>' /></td>
            <td>
            ...
            <td>
                ...
                <strong class="colorG">
                    <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin2" runat="server" Money='<%# (decimal)Eval("ItemCostPrice")*(int)Eval("ShipmentQuantity") %>' /></strong>
            </td>
...
<asp:Repeater ID="grdOrderGift" runat="server">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <%# Eval("PromoteType").ToInt() == (int)Hidistro.Entities.Promotions.PromoteType.SentGift?"商品促销":(Eval("PromoteType").ToInt() == (int)Hidistro.Entities.Promotions.PromoteType.FullAmountSentGift?"订单促销":"积分兑换") %>    
            </td>
        </tr>
    </ItemTemplate>
    <FooterTemplate>
