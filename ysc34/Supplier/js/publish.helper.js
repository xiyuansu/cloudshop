...
function GotoNext() {
    ...
    if (formpost) {
        ...
        if (productId != "" && productId.length > 0)
            ...
            form.action = "editproduct.aspx?categoryId=" + selectedCategoryId;
        form.submit();
    }
    else {
        if (productId != "" && productId.length > 0)
            window.location.href = "editproduct.aspx?categoryId=" + selectedCategoryId + "&productId=" + productId;
        else {
            window.location.href = "editproduct.aspx?categoryId=" + selectedCategoryId;
        }
    }
