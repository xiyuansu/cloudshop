...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody areacolumn clearfix">
        <div class="title">
            <ul class="title-nav">
                ...
                <li class="hover"><a href="javascript:void">规 格</a></li>
            </ul>
        </div>
        <div class="columnright">
            <div class="content">
                ...
                <script id="datatmpl" type="text/html">
                  ...
                  <a name="button" id="button" href="javascript:EditSkuDiv('{{item.AttributeName}}','{{item.UseAttributeImage.toString()}}','{{item.AttributeId}}');">修改</a>
                        </td>
            ...
            <div class="Pg_15">
                <a name="button" id="button" class="btn btn-primary " onclick="AddSkuDiv();">添加新规格</a>
            </div>
    ...
    <input type="hidden" name="dataurl" id="dataurl" value="/admin/product/ashx/EditSpecification.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/QW.Repeater.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/admin/product/scripts/EditSpecification.js" type="text/javascript"></script>
</asp:Content>
