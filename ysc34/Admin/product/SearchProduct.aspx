<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SearchProduct" Title="选择商品" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="Server">
    <style>
        ...
        #mainhtml { margin: 0; padding: 20px 20px 80px 20px; width: 100% !important; }
    </style>
                ...
                <tr>
                    ...
                    <td>
                        <div style="float: left; margin-right: 10px; width: 13%;">
                            <a href='../../ProductDetails.aspx?productId={{item.ProductId}}' target="_blank" style="border-width: 0px; width: 40px; height: 40px;">    
                                {{if item.ThumbnailUrl40}}
                                    <img src="{{item.ThumbnailUrl40}}" runat="server" style="border-width: 0px; width: 40px; height: 40px;" alt="" />
                                {{else}}
                                    <img src="/utility/pics/none.gif" runat="server" id="productdImg" style="border-width: 0px; width: 40px; height: 40px;" alt="" />
                                {{/if}}
                            </a>
                        </div>
    ...
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/product/ashx/SearchProduct.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/product/scripts/SearchProduct.js?v=3.1" type="text/javascript"></script>
</asp:Content>
