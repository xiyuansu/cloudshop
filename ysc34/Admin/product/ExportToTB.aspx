...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li class="hover"><a href="javascript:void">导出为淘宝数据包</a></li>
                <li><a href="exporttolocal.aspx">导出为本地数据包</a></li>
        ...
        <div class="searcharea clearfix">
            <ul>
                ...
                <li class="formselect">
                    <span>淘宝状态：</span>
                    <asp:DropDownList ID="dpTaoBao" runat="server" CssClass="iselect" ClientIDMode="Static">
                ...
                <li class="P_state"><span>包含状态：</span>
                ...
                <li>
                    <input type="button" name="btnSearch" value="筛选" id="btnSearch" class="btn btn-primary" />
                </li>
            </ul>
        </div>
        <!--结束-->
        <div class="functionHandleArea">
            ...
            <div class="pageHandleArea">
                <ul>
                    ...
                    <li><span class="fl ml20">导出版本：</span><asp:DropDownList ClientIDMode="Static" runat="server" ID="dropExportVersions" CssClass="iselect"></asp:DropDownList></li>
                    <li style="width: 200px">
                        <span class="formitemtitle ml_20">导出库存数量：</span><Hi:OnOff runat="server" ID="chkExportStock"></Hi:OnOff>
                    </li>
                    <li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/product/ashx/ExportToTB.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/product/scripts/ExportToTB.js" type="text/javascript"></script>
</asp:Content>
