<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditAccount.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditAccount" %>
        ...
        <div class="columnright" style="width: 500px;">
            ...
            <div class="formitem">
                ...
                <div class="modal_iframe_footer">
                    <asp:Button ID="btnSubmit" runat="server" Text="确  定" OnClientClick="return checkSubmit()" CssClass="btn btn-primary" />
                </div>
            </div>
