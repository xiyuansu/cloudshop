<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master"  AutoEventWireup="true" CodeBehind="WapTopicLink.aspx.cs" Inherits="Hidistro.UI.Web.Admin.store.WapTopicLink" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="Server">
    ...
    <asp:HiddenField runat="server" ID="hidClientName" ClientIDMode="Static" />
        ...
        <div class="columnright">
            <div class="formitem validator2">
                <div style="text-align:center">
                    ...
                    <div class="copy">
                        <a id="adownload" href="#" onclick="$('#ctl00_contentHolder_btnDownLoad').click()">下载二维码</a>
