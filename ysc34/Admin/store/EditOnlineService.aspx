<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditOnlineService.aspx.cs" Inherits="Hidistro.UI.Web.Admin.store.EditOnlineService" %>
                ...
                <ul>
                    <li><span class="formitemtitle"><em>*</em>在线客服类型：</span>
                        <abbr class="formselect">
                            <Hi:ServiceTypeDropDownList runat="server" AllowNull="true" ID="dropServiceType" CssClass="iselect"></Hi:ServiceTypeDropDownList>
                        </abbr>
                    ...
                    <li><span class="formitemtitle">是否显示：</span>
                        <Hi:YesNoRadioButtonList ID="radioShowStatus" RepeatLayout="Flow" runat="server" />
                        <p id="radioShowStatusTip" runat="server"></p>
                    </li>
                </ul>
                <div class="ml_198">
                  
                        <asp:Button ID="btnSubmit" runat="server" Text="保 存" OnClientClick="return SubmitCheck()"  CssClass="btn btn-primary" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            initValid(new InputValidator('ctl00_contentHolder_txtAccount', 0, 50, false, null, '客服帐号不能为空，且长度限制在5个字符以内'));
            initValid(new InputValidator('ctl00_contentHolder_txtNickName', 0, 50, false, null, '昵称不能为空，且长度限制在5个字符以内'));
