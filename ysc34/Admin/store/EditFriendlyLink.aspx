    ...
    <div class="areacolumn clearfix databody">
        <div class="columnright">
            ...
            <div class="formitem">
                <ul>
                    <li class="mb_0">
                        <span class="formitemtitle"><em>*</em>网站名称：</span>
                        <asp:TextBox ID="txtaddTitle" runat="server" CssClass="forminput form-control" Style="width: 281px;" placeholder="长度限制在60个字符以内"></asp:TextBox>
                    ...
                    <li>
                        <span class="formitemtitle">网站地址：</span>
                        <asp:TextBox ID="txtaddLinkUrl" runat="server" CssClass="forminput form-control" Style="width: 281px;"></asp:TextBox>
                    </li>
                    <li>
                        <span class="formitemtitle">是否显示：</span>
                        <Hi:OnOff ID="ooShowLinks" runat="server"></Hi:OnOff>
                    </li>
                </ul>
                <div class="ml_198">
                    <asp:Button ID="btnSubmitLinks" runat="server" Text="确 定" OnClientClick="return getUploadImages()" CssClass="btn btn-primary" />
