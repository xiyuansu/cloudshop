                ...
                <div class="formitem mt_10">
                    <ul>
                        ...
                        <li  class="mb_0"><span class="formitemtitle"><em>*</em>投票选项：</span>
                            <asp:TextBox ID="txtValues" runat="server"  Height="100" CssClass="form_input_l form-control" TextMode="MultiLine" placeholder="一行一个投票选项"></asp:TextBox>
                            <p id="ctl00_contentHolder_txtValuesTip"></p>
                        </li>
                        <li>
                            <span class="formitemtitle">展示位置：</span>
                            <span class="icheck-label-5-10">
                                <asp:CheckBox ID="chkDisplayWeixinStatic" ClientIDMode="Static" runat="server" Text="微商城" CssClass="icheck ml_20" />
                                </span>
                        ...
                        <li  class="mb_0" id="likey" runat="server" visible="false"><span class="formitemtitle">关键字：</span>
                            ...
                            <asp:HiddenField ID="txtOldKeys" runat="server" />
                    ...
                    <div class="ml_198">
                        <asp:Button ID="btnEditVote" runat="server" Text="保 存" OnClientClick="return getUploadImages()" CssClass="btn btn-primary" />
                    </div>
                </div>
