<%@ Page Title="达达物流设置" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DadaLogistics.aspx.cs" Inherits="Hidistro.UI.Web.Admin.DadaLogistics" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li><a  href="../depot/Setting/Config.aspx">门店设置</a></li>
                <li><a  href="../depot/Setting/MarketingImageList.aspx">营销图库</a></li>
                <li><a  href="../depot/Setting/MarktingList.aspx">营销图标设置</a></li>
                <li><a  href="../depot/Setting/TagList.aspx">门店标签设置</a></li>
                <li><a  href="../depot/StoreSetting.aspx">门店APP推送设置</a></li>
                <li><a href="../depot/Setting/StoreAppDonwload.aspx">门店APP下载设置</a></li>
