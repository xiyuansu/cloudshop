<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PcTopicTempEdit.aspx.cs" Inherits="Hidistro.UI.Web.Admin.store.PcTopicTempEdit" %>
...
<head runat="server">
    ...
    <title>编辑专题 - PC版</title>
    <!-- 线上环境 -->
    <link rel="stylesheet" href="/Admin/PcShop/Public/css/dist/component-min.css" />
    <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/jbox/jbox-min.css" />
    <!-- diy css start-->
    <link rel="stylesheet" href="/Admin/PcShop/PublicMob/css/style.css" />
    <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/diy/diy-min.css" />
    <link rel="stylesheet" href="/Utility/Ueditor/plugins/uploadify/uploadify-min.css" />
    <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/colorpicker/colorpicker.css" />
    <!-- diy css end-->
    <link rel="stylesheet" href="/Admin/PcShop/Public/css/dist/home/Shop/edit_homepage.css" />
...
<body>    
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="pageclient" value="pctopic" />
        <div class="container">
            <div class="inner clearfix">
                ...
                <div class="content-right fl" style="border: none; width: 100%;">
                    ...
                    <div class="diy clearfix div_center">
                        <div class="diy-phone-outbox clearfix">
                            <div id="diy-phone">
                                <div class="diy-phone-header">
                                    ...
                                    <%--<div class="diy-phone-title j-pagetitle">PC专题主页</div>--%>
                                </div>
                                <div class="diy-phone-contain" id="diy-contain">
                                    <div style="width:100%;background:url(../images/topic_head_bg.jpg);">
                                    <img src="../images/topic_head.jpg" style="width:1180px;margin:0 auto;display:block;" />
                                        </div>
                                    <div class="nodrag"></div>
                                    <div class="drag" style="margin-top:-20px;"></div>
                                </div>
                            ...
                            <div class="diy-actions">
                                ...
                                <div class="diy-actions-addModules clearfix">
                                    <div class="tab">
                                        <a href="javascript:;" class="diy-phone-titl j-pagetitle">
                                            <b>背景<br />
                                                设置</b>
                                        </a>
                                    </div>
                        ...
                        <div id="diy-ctrl" >
                            <div class="diy-ctrl-item" data-origin="pagetitle" style="margin-top: 85px;"  id="default_item">
                                <div class="formitems">
                                    <h1>背景设置<i class="iconfont" id="close_edit">&#xe601;</i></h1>
                                    <label class="fi-name"><font>*</font>专题名称：</label>
                                    <div class="form-controls">
                                        <input type="text" class="input j-pagetitle-ipt" value="" />
                                    </div>
                                    <label class="fi-name">背景颜色：</label>
                                    <div class="form-controls">
                                        <input type="text" class="input backgroundColor" style="border:1px solid #ccc;"  value="" readonly   placeholder="颜色选择" />
                                        <span class="fi-help-text"></span>
                                    </div>
                                    <label class="fi-name">背景图片：</label>
                                    <div class="form-controls">
                                        <div id="imageContainer">
                                            <span name="bgImage" class="imgbox"></span>
                                            <asp:HiddenField ID="hidUploadImages" runat="server" ClientIDMode="Static" />
                                        </div>
                                    </div>
                                    <label class="fi-name">背景图填充方式：</label>
                                    <div class="form-controls bg_c">
                                        <label>
                                            <input type="radio" name="repeat" class="repeat" value="repeat" checked />平铺</label>
                                        <label>
                                            <input type="radio" name="repeat" class="repeat" value="repeat-y"  />纵向平铺</label>
                                        <label>
                                            <input type="radio" name="repeat" class="repeat" value="repeat-x"   />横向平铺</label>
                                        <label>
                                            <input type="radio" name="repeat" class="repeat" value="no-repeat"  />不平铺</label>
                                        <label>
                                            <input type="radio" name="repeat" class="fixed" value="fixed"  />背景固定</label>
                                    </div>
                                       <label class="fi-name">背景对齐：</label>
                                    <div class="form-controls bg_c">
                                        <label>
                                            <input type="radio" name="position" class="position" value="left" checked />左对齐</label>
                                        <label>
                                            <input type="radio" name="position" class="position" value="center"  />居中</label>
                                        <label>
                                            <input type="radio" name="position" class="position" value="right"   />右对齐</label>                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="diy-actions-submit">
                            <a href="javascript:;" class="btn btn-primary" id="j-savePage-pc">保存</a>
        ...
        <script type="text/j-template" id="tpl_diy_ctrl_type1">
            <h1>编辑内容<i class="iconfont" id="close_edit"></i></h1>
        ...
        <div class="members_con">
            ...
            <section class="members_goodspic">
                <ul>
                    ...
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView1.jpg" width="100%"></a>
                             <section class="members_goodsimg_name rename">
                    ...
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView2.jpg" width="100%"></a>
                             <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
                    ...
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView3.jpg" width="100%"></a>
                             <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
                    ...
                    <li class="mingoods">
                        <div class="b_mingoods_wrapper">
                            <a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView4.jpg" width="100%"></a>
                             <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
            ...
            <section class="members_goodspic">
                <ul>
                    ...
                    <# } else { #>
                    <li class="biggoods">
                        <a class="goodsimg" href=""><img src="/Admin/PcShop/Public/images/diy/goodsView1.jpg" width="100%"></a>
                        <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
                            <span><i></i> 780.00<span class="original_price"><s>&yen;999</s></span></span>
                        </section>
                    </li>
                    <li class="biggoods">
                        <a class="goodsimg" href=""><img src="/Admin/PcShop/Public/images/diy/goodsView2.jpg" width="100%"></a>
                        <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
                    ...
                    <li class="biggoods">
                        <a class="goodsimg" href=""><img src="/Admin/PcShop/Public/images/diy/goodsView3.jpg" width="100%"></a>
                        <section class="members_goodsimg_name rename">
                            <# if(content.showName == 1||content.showName === undefined){ #>
                            <a href="">大图商品名称</a>
                            <# } #>
                ...
                <ul>
                    ...
                    <li class="b_mingoods <# if(index%3==1){ #>goods_even<# } #><# if(index%3==2){ #>goods_odd<# } #>">
                        <div class="b_mingoods_wrapper">
                            <a href="<#= goods.link #>">
                                <# if(goods.is_compress){ #>
                                    <img src="<#= goods.pic #>300x300" width="100%" height="132">
                                <# }else{ #>
                                    <img src="<#= goods.pic #>" width="100%" height="132">
                                <# } #>
                            </a>
                            <section style="height:44px;">
                                <p class="title"><#= goods.title #></p>
                                <p class="pic_box"><span class="pirce"><span class="yen">&yen;</span><#= goods.price#></span><# if(goods.original_price>0){ #><span class="yj">&yen;<#= goods.original_price#></span><# } #></p>
                            </section>
                    ...
                    <li class="biggoods">
                        ...
                        <section class="members_goodsimg_name rename">
                            <a href="">大图商品名称</a>
                            <span>780.00<span class="original_price"><s>&yen;999</s></span></span>
                        </section>
                    </li>
                    <li class="mingoods">
                    <div class="b_mingoods_wrapper">
            ...
            <section class="members_goodslist">
                <ul>
                    ...
                    <# } else { #>
                    <li class="g-box por rebox">
                        <section><a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView1.jpg" width="88" height="88"></a></section>
                        <section class="g-flex">
                            <a href="">此处显示商品名称</a>
                            <p>&yen;32434.00</p>
                        </section>                       
                    ...
                    <li class="g-box por rebox">
                        <section><a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView2.jpg" width="88" height="88"></a></section>
                        <section class="g-flex">
                            <a href="">此处显示商品名称</a>
                            <p>&yen;32434.00</p>
                        </section>                       
                    ...
                    <li class="g-box por rebox">
                        <section><a href=""><img src="/Admin/PcShop/Public/images/diy/goodsView3.jpg" width="88" height="88"></a></section>
                        <section class="g-flex">
                            <a href="">此处显示商品名称</a>
                            <p>&yen;32434.00</p>
                        </section>                       
                ...
                <ul>
                    ...
                    <li class="b_mingoods <# if(index%2==0){ #>goods_even<# }else{ #>goods_odd<# } #>">
                        <div class="b_mingoods_wrapper">
                            ...
                            <# if(content.showIco || content.showPrice){ #>
                            <p class="title"><#= goods.title #></p>
                            <p class="pic_box"><span class="pirce">&yen;<#= goods.price#></span><# if(goods.original_price>0){ #><span class="yj">&yen;<#= goods.original_price#></span><# } #></p>
                            <# } #>
        ...
        <script type="text/j-template" id="tpl_diy_ctrl_type4">
            <h1>商品列表<i class="iconfont" id="close_edit">&#xe601;</i></h1>
        <div class="formitems">
            <label class="fi-name">布局方式：</label>
            <div class="form-controls">
                <div class="radio-group">
                    <label><input type="radio" name="layout" value="1" <# if(content.layout==1){ #>checked<# } #>> 一排5个</label>
                    <label><input type="radio" name="layout" value="2" <# if(content.layout==2){ #>checked<# } #>> 一排4个</label>                  
                </div>
            </div>
        </div>
        <# if(content.layout>0){ #>
...
<div class="formitems">
            ...
            <section class="members_nav1">
                <ul>
                   ...
                   <# if(item.pic && item.pic!=""){ #>
                    ...
                    <#}else{#>
                    <li class="lisw<#= content.dataset.length #>">
                        <span><a href="<#= item.link #>"><img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg" ></a></span>
                        <%--<a class="members_nav1_name" href="<#= item.link #>"><#= item.showtitle #></a>--%>
                    </li>
                    <#}#>
                    <# }) #>
                    <# }else{ #>
                    <li>
                        <span><a href=""><img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg" ></a></span>
            ...
            <li class="ctrl-item-list-li clearfix">
                <div class="fl">
                    <div class="imgnav j-selectimg">
                        ...
                        <# }else{ #>
                        <img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg">
                        <span class="imgnav-reselect">重新选择</span>
                        <# } #>
                    </div>
        ...
        <div class="members_con top_1" style="margin:<# if(content.space == 1){ #>10px auto<# }else{ #>20 auto<# } #>;width:100%;">
            ...
            <section class="members_flash j-swipe" id="mySwipe">
                <ul class="clearfix">
                    ...
                    <# }else{ #>
                    <li><a href="" title=""><img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg" /></a></li>
                    <# } #>
                </ul>
        ...
        <div class="members_con top_1" style="margin:<# if(content.space == 1){ #>0 0 20px 0<# }else{ #>0 auto<# } #>;width:100%;">
            <# if(content.showType==1){ #>
            <section class="members_flash j-swipe" id="mySwipe">
                <ul class="clearfix">
                    <# if(content.dataset.length){ #>
                        <# _.each(content.dataset,function(item){ #>
                            <li>
                                <a href="<#= item.link #>" title="<#= item.showtitle #>">
                                    ...
                                    <# } #>
                                    <# }else{ #>
                                    <img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg" width="100%" />
                                    <# } #>
                                </a>
                            </li>
                        <# }) #>
                    <# }else{ #>
                    <li><a href="" title=""><img src="/Admin/PcShop/Public/images/diy/pctopic_banner.jpg" width="100%" /></a></li>
                    <# } #>
                </ul>
                <section class="members_flash_time">
                    <# if(content.dataset.length>1){ #>
                ...
                <ul class="clearfix">
                    ...
                    <li style="margin-bottom:<# if(!content.margin){ #>0<# }else{ #><#= content.margin #><# } #>px">
                        <a href="<#= item.link #>" title="<#= item.showtitle #>">
                            ...
                            <# } #>
                            <# }else{ #>
                            <img src="/Admin/PcShop/Public/images/diy/imgad.jpg" width="100%" />
                            <# } #>
                        </a>
                    </li>
                    <# }) #>
        ...
        <script type="text/j-template" id="tpl_diy_ctrl_type9">
            <h1>图片广告<i class="iconfont" id="close_edit"></i></h1>
       ...
       <%-- <div class="formitems mgb10">
        ...
        <ul class="ctrl-item-list mgt10">
            ...
            <li class="ctrl-item-list-li">              
                <div class="formitems">
                    <label class="fi-name">专题名称：</label>
                    <div class="form-controls">
            ...
            <label class="fi-name">背景图填充方式：</label>
            <div class="form-controls">
                <label><input type="radio" name="showstyle" value="0" <# if(content.style == 0||!content.style){ #>checked<# } #> >平铺</label>
                <label><input type="radio" name="showstyle" value="1" <# if(content.style == 1){ #>checked<# } #> >纵向平铺</label>
                <label><input type="radio" name="showstyle" value="1" <# if(content.style == 2){ #>checked<# } #> >横向平铺</label>
                <label><input type="radio" name="showstyle" value="1" <# if(content.style == 3){ #>checked<# } #> >不平铺</label>
            </div>
        </div>
        <div class="formitems">
             <label class="fi-name">背景对齐：</label>
            <div class="form-controls">
                <label><input type="radio" name="marginstyle" value="0" <# if(content.marginstyle == 0||!content.marginstyle){ #>checked<# } #> >左对齐</label>
                <label><input type="radio" name="marginstyle" value="1" <# if(content.marginstyle == 1){ #>checked<# } #> >居中</label>
            <label><input type="radio" name="marginstyle" value="1" <# if(content.marginstyle == 1){ #>checked<# } #> >右对齐</label>
            </div>
        </div>
            </li>
            <# }) #>
            ...
            <section class="members_nav1">
                <ul class="clearfix">
                    ...
                    <li class="board3 <# if(content.layout == 1){ #>big_board<# } #>">
                        <span><a href=""><img src="/Public/images/diy/pctopic_banner.jpg"></a></span>
                    </li>
       ...
       <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/diy/diy-min.css" />
        ...
        您选择了默认主题
         <# } else if(content.layout==2){ #>
        <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/diy/blue.css" />
         <br>
        您选择了蓝色主题
         <# } else if(content.layout==3){ #>
        <link rel="stylesheet" href="/Admin/PcShop/Public/plugins/diy/diy-min.css" />
       ...
       <div class="formitems">
        ...
        <script src="/Admin/PcShop/Public/js/dist/lib-min.js"></script>
        <script src="/Admin/PcShop/Public/plugins/jbox/jquery.jbox-min.js"></script>
        <script src="/Admin/PcShop/Public/plugins/zclip/jquery.zclip-min.js"></script>
        <!-- 线上环境 -->
        <script src="/Admin/PcShop/Public/js/dist/component-min.js?v=3.20"></script>
        <script src="/Admin/PcShop/Public/modulesJs/scroll.js"></script>
        <!--[if lt IE 10]>
    ...
    <![endif]-->
        ...
        <script src="/Admin/PcShop/Public/js/jquery-ui/jquery-ui.min.js"></script>
        <script src="/Admin/PcShop/Public/js/config.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.core.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.base64code.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.data2html.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.events.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.verify.js"></script>
        <script src="/Admin/PcShop/Public/plugins/diy/diy.init.js"></script>
        <script type="text/javascript" src="/admin/js/bootstrap.min.js"></script>
        <script src="/Admin/PcShop/Public/plugins/colorpicker/colorpicker.js"></script>
        <%--<script src="<%=scriptSrc %>"></script>--%>
        <script src="/Admin/PcShop/Public/js/dist/home/shop/edit_homepage.js"></script>
   ...
   <script type="text/javascript" src="/utility/jquery.hishopUpload.js" ></script>
    ...
    <link id="cssLink" rel="stylesheet" href="../css/style.css" type="text/css" media="screen" />
            ...
            $(function () {
                ...
                $('.backgroundColor').ColorPicker({
                    ...
                    onChange: function (hsb, hex, rgb) {
                        var hex = '#' + hex;
                        $('.backgroundColor').css('backgroundColor', hex);
                        $('.backgroundColor').val(hex);
                        $('#diy-contain').css('backgroundColor', hex);
                    },
                });
            });
            function gggoup() {
        ...
        function initImageUpload() {
            var imgSrc = $("#hidUploadImages").val();
            $('#imageContainer span[name="bgImage"]').hishopUpload(
                           {
                               title: '背景图片',
                               url: "/admin/UploadHandler.ashx?action=newupload",
                               imageDescript: '',
                               displayImgSrc: imgSrc,
                               imgFieldName: "bgImage",
                               defaultImg: '',
                               pictureSize: '',
                               imagesCount: 1,
                               dataWidth: 9,
                               callback: function (imgurl) { onSelectedImg(imgurl); }
                           });
        }

        function onSelectedImg(imgurl) {
            $("#<%=hidUploadImages.ClientID%>").val(imgurl);
            $('#diy-contain').css('background-image', "url(" + imgurl + ")");
        }
            $(function () {
                var w = $("body").width() / 2;
                $("#default_item").css({"left": w - 286,"display":"block"});


                $(".repeat").click(function () {
                    var repeat = $(this).val();
                    $('#diy-contain').css('background-repeat', repeat);                    
                })

                $(".fixed").click(function () {
                    var repeat = $(this).val();
                    $('#diy-contain').css('background-attachment', repeat);
                })
                
                $(".position").click(function () {
                    var position = $(this).val() + " top";
