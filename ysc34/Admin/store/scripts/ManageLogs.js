...
function initQuery(obj) {
    var OperationUserName = $("#dropOperationUserNames").val();
    if (OperationUserName.toString().length > 0) {
        obj.OperationUserName = OperationUserName;
    }
    var FromDate = $("#calenderFromDate").val();
    if (FromDate.toString().length > 0) {
        obj.FromDate = FromDate;
    }
    var ToDate = $("#calenderToDate").val();
