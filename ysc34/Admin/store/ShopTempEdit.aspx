<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopTempEdit.aspx.cs" Inherits="Hidistro.UI.Web.Admin.store.ShopTempEditNew" %>
...
<body>
    <form id="thisForm" runat="server">
        ...
        <input type="hidden" id="themeName" runat="server" clientidmode="Static" />
                    ...
                    <div class="diy clearfix div_center">
                        <div class="diy-actions">
                            ...
                            <div class="diy-actions-addModules clearfix">
                                ...
                                <div class="tab">
                                    <a href="javascript:;" class="j-diy-addModule" data-type="20">橱窗2</a>
                                </div>
                                <div class="tab">
                                    <a href="javascript:;" class="j-diy-addModule" data-type="21">橱窗3</a>
                                </div>
                                <div class="tab">
                                    <a href="javascript:;" class="j-diy-addModule" data-type="22">橱窗4</a>
                                </div>
                                <div class="tab">
                                    <a href="javascript:;" class="j-diy-addModule" data-type="23">橱窗5</a>
                                </div>
                            </div>
                        ...
                        <div id="diy-ctrl">
                            <div class="diy-ctrl-item" data-origin="pagetitle" style="margin-top: 85px;">
                                <div class="formitems">
                                    ...
                                    <div class="form-controls">
                                        <input type="text" class="input j-pagetitle-describe" value="页面描述">
                                    </div>
                                    <label class="fi-name">分享图标：</label>
                                    <div class="form-controls">
                                        <div id="imageContainer">
                                            <span name="defaultImage" class="imgbox"></span>
                                            <input type="hidden" id="hidOldImages" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="formitems">
        ...
        <div class="formitems">
            ...
            <div class="form-controls pdt5">
                <ul class="img-list img-list-drag clearfix">
                ...
                <ul>
                    ...
                    <div class="b_mingoods_wrapper">
                        ...
                        <span class="replace">
                            ...
                            <# if(content.showPrice){ #>
                            &yen;<#= goods.price#>
                            <# if(goods.original_price>0){ #><span class="original_price"><s>&yen;<#= goods.original_price#></s></span></span><# } #>
                            <# } #>
                        </span>
                        <# } #>
                        </div>
...
<div class="formitems">
        ...
        <div class="Header_style12_panel" style="<# if(content.style == 1){ #>height:50px;<# }else{ #>height:44px;<# } #>">
            <div class="membersbox" style="<# if(content.style == 1){ #>height:50px;<# }else{ #>height:44px;<# } #>">
                ...
                <div class="homeCnav">
                    <div class="homeCnavbox">
                        <ul class="topnav clearfix">
                            <# _.each(content.dataset,function(item){ #>
                            <li class="liwid<#=content.dataset.length #>">
                ...
                <div class="homeCnav" style="height:44px;line-height:44px;">
                    <div class="homeCnavbox" style="height:44px;line-height:44px;">
                        <ul class="topnav clearfix" style="height:44px;line-height:44px;">
                            <# _.each(content.dataset,function(item){ #>
                            <li class="liwid<#=content.dataset.length #>" style="height:44px;line-height:44px;">
        ...
        <div class="members_con">
            <section class="members_nav1">
                <ul class="clearfix">
                    ...
                    <# if(content.layout == 1){ #>
                    <li class="board<#= content.dataset.length #> <# if(content.layout == 1&&e == 0){ #>big_board<# } #><# if(content.layout == 1&&e != 0){ #>small_board<# } #>">
                        <span>
                            <a href="<#= item.link #>">
                                <# if(item.is_compress){ #>
        ...
        <div class="members_con">
           ...
           <ul class="clearfix">
                    ...
                    <# _.each(content.dataset,function(item,e){ #>
                    <# if(content.layout == 1){ #>
                    <li class="board<#= content.dataset.length #><# if(content.layout == 1&&e == 0){ #> big_img<# } #><# if(content.layout == 1&&e == 1){ #> mid_img<# } #><# if(content.layout == 1&&e >= 2){ #> small_img<# } #>">
                        <span>
                            <a href="<#= item.link #>">
             <# if(item.is_compress){ #>
                                <img src="<#= item.pic #>_80x80">
            ...
            <li class="ctrl-item-list-li clearfix">
                ...
                <div class="fl imgnav-info">            
                    <div class="formitems">
                      ...
                      <# if(item.linkType && item.linkType!=10 && item.linkType!=23){ #>        
                            <a href="<#= item.link #>" target="_blank" class="badge badge-success" title="<#= item.title #>">
                                <span><#= HiShop.linkType[item.linkType] #></span>
                                <em class="badge-link ovfEps"><#= item.title #></em>
                            </a>
        ...
        <div class="members_con">
           ...
           <ul class="clearfix">
                    ...
                    <# _.each(content.dataset,function(item,e){ #>
                    <# if(content.layout == 1){ #>
                    <li class="board<#= content.dataset.length #><# if(content.layout == 1&&e == 0|| e == 3){ #> mid1_img<# } #><# if(content.layout == 1&& e ==1||e==2||e==4||e==5){ #> small1_img<# } #>">
                        <span>
                            <a href="<#= item.link #>">
             <# if(item.is_compress){ #>
                                <img src="<#= item.pic #>_80x80">
      ...
      <ul class="ctrl-item-list">
        ...
        <div class="members_con">
           ...
           <ul class="clearfix">
                    ...
                    <# _.each(content.dataset,function(item,e){ #>
                    <# if(content.layout == 1){ #>
                    <li class="board<#= content.dataset.length #><# if(content.layout == 1&&e == 0){ #> big1_img<# } #><# if(content.layout == 1&&e != 0){ #> big1_img<# } #>">
                        <span>
                            <a href="<#= item.link #>">
             <# if(item.is_compress){ #>
                                <img src="<#= item.pic #>_80x80">
      ...
      <ul class="ctrl-item-list">
        ...
        <div class="members_con">
           ...
           <ul class="clearfix">
                    ...
                    <# _.each(content.dataset,function(item,e){ #>
                    <# if(content.layout == 1){ #>
                    <li class="board<#= content.dataset.length #><# if(e<4){ #> big1_img<# } #><# if(e > 3){ #> small2_img<# } #>">
                        <span>
                            <a href="<#= item.link #>">
             <# if(item.is_compress){ #>
                                <img src="<#= item.pic #>_80x80">
    ...
    <![endif]-->
        ...
        <script src="/Admin/shop/Public/plugins/diy/diy.events.js?v=3.38"></script>
