<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopicTempEdit.aspx.cs" Inherits="Hidistro.UI.Web.Admin.store.TopicTempEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="pageclient" value="topic" />
        <div class="container">
                        ...
                        <div class="diy-phone-outbox clearfix">
                            <div id="diy-phone">
                                <div class="diy-phone-header">
                                    ...
                                    <div class="diy-phone-title j-pagetitle">移动端专题主页</div>
                                </div>
                        ...
                        <div class="b_mingoods_wrapper">
                            ...
                            <section style="height:44px;">
                             ...
                             <# if(content.showIco){ #>
                                 <i class="btnAddToCart" productid="<#= goods.item_id #>"></i>
                                <# } #>
                                    <span class="yen">&yen;</span><#= goods.price#></span>
                                    <# if(goods.original_price>0){ #><span class="yj">&yen;<#= goods.original_price#></span><# } #></p>
                            </section>
                        </div>
                    </li>
                    <# } #>
