    ...
    HiShop.popbox.dplPickerColletion = function (a) {
        ...
        switch (parseInt(c.linkType)) {
            ...
            case 7:
                var d = {
                    title: "会员主页",
                    link: "javascript:goMerberCenter();"
                };
                c.callback(d, 7);
                break;
            case 8:
                var d = {
                    title: "购物车",
                    link: "javascript:goToShoppingCart();"
                };
                c.callback(d, 8);
                break;
            case 9:
            ...
            case 19:
                var d = {
                    title: "火拼团",
                    link: "javascript:goFightGroupList();"
                };
                c.callback(d, 19);
                break;
            case 20:
                var d = {
                    title: "周边门店",
                    link: "javascript:OpenUrl('nearstorelist');"
                };
                c.callback(d, 20);
                break;
            case 21:
