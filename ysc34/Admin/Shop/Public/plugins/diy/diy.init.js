$(function () {
    ...
    $(".j-diy-addModule").click(function () {
        ...
        if (strUrl.indexOf('xcxshoptempedit') >= 0) {
            clientName = "xcxshop";
        }
                    ...
                    dataset: [
                        {
                            ...
                            link: "#",
                            title: "导航名称",
                            pic: "/Admin/shop/Public/images/diy/group_1.jpg"
                        },
                        {
                            linkType: 0,
                            link: "#",
                            title: "导航名称",
                            pic: "/Admin/shop/Public/images/diy/group_2.jpg"
                        },
                        {
                            linkType: 0,
                            link: "#",
                            title: "导航名称",
                            pic: "/Admin/shop/Public/images/diy/group_3.jpg"
                        }
                    ]
                }
                break;
                    ...
                    dataset: [
                          {
                              ...
                              link: "#",
                              title: "导航名称",
                              pic: "/Admin/images/app/bar02.png"
                          },
                    ]
                }
                break;
...
function pushAppFistModel(ary, clientName) {
    ...
    if (clientName == "appshop" || clientName == "xcxshop") {
        ...
        ary.content.dataset.splice(0, 0, firstModel)
        console.log(ary.content.dataset);
    }
}
