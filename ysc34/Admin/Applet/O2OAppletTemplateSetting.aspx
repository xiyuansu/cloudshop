<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="O2OAppletTemplateSetting.aspx.cs" Inherits="Hidistro.UI.Web.Admin.O2OAppletTemplateSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <asp:Repeater ID="grdWxTempletsNew" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" Text='<%# Eval("WxO2OAppletTemplateId") %>' messagetype='<%# Eval("MessageType") %>' Width="350px" CssClass="forminput form-control"></asp:TextBox>
                        </td>
                    </tr>
                </ItemTemplate>
    ...
    <script type="text/javascript" src="/Admin/Applet/scripts/O2OAppletTemplatesSetting.js?v=3.2"></script>
