...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <div class="formitem validator3">
                <ul>
                    ...
                    <li><span class="formitemtitle ">分类介绍：</span>
                        <asp:TextBox ID="txtHelpCategoryDesc" TextMode="MultiLine" Height="100" CssClass="form_input_l form-control" runat="server" placeholder="分类介绍最多只能输入300个字符"></asp:TextBox>
    ...
    <div class="modal_iframe_footer">
        <asp:Button ID="btnSubmitHelpCategory" runat="server" OnClientClick="return getUploadImages();" Text="保 存" CssClass="btn btn-primary" />
    </div>
</asp:Content>
