...
function post_delete(consultationId) {


    var dataurl = "/admin/comment/ashx/ProductConsultations.ashx";
    var candel = false;
    candel = confirm("确定要执行该删除操作吗？删除后将不可以恢复！");
    if (candel) {
        var urldata = { consultationId: consultationId, action: "delete" }
