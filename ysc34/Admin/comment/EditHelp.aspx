     ...
     <div class="title">
      ...
      <div class="formitem">
        <ul>
          ...
          <span class="formitemtitle "><em >*</em>所属分类：</span><abbr class="formselect">
          ...
          <li class="mb_0"> <span class="formitemtitle "><em >*</em>主题：</span>
           <asp:TextBox ID="txtHelpTitle" runat="server" CssClass="form_input_m form-control" placeholder="长度限制在60个字符以内"></asp:TextBox>
            <p id="ctl00_contentHolder_txtHelpTitleTip"></p>
          </li>
          <li> <span class="formitemtitle ">搜索描述：</span>
	          <Hi:TrimTextBox runat="server" CssClass="form_input_m form-control" ID="txtMetaDescription" placeholder="长度限制在20个字符以内" />
            </li>
	        <li> <span class="formitemtitle ">搜索关键字：</span>
	          <Hi:TrimTextBox runat="server" CssClass="form_input_m form-control" ID="txtMetaKeywords" placeholder="长度限制在160个字符以内" />
	        </li>
          ...
          <li><span class="formitemtitle "><em >*</em>内容：</span>
            <span><Hi:Ueditor id="fcContent" runat="server"  Width="660" /></span>
          </li>
         <li></li>
      </ul>
          ...
          <div class="ml_198">
         <asp:Button ID="btnEditHelp" runat="server" OnClientClick="return PageIsValid();" Text="保存"  CssClass="btn btn-primary"/>
        </div>
      </div>
  </div>
