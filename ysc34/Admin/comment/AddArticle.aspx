...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="areacolumn clearfix databody">
            <div class="title">
                <ul class="title-nav">
                    <li><a href="ArticleList.aspx">管理</a></li>
        ...
        <div class="columnright">
            <div class="formitem">
                <ul>
                    <li><span class="formitemtitle"><em>*</em>所属分类：</span>
                        <abbr class="formselect">
                            <Hi:ArticleCategoryDropDownList ID="dropArticleCategory" CssClass="iselect" AllowNull="true" runat="server" NullToDisplay="请选择所属分类" ></Hi:ArticleCategoryDropDownList>
                        </abbr>
                    ...
                    <li>
                        <span class="formitemtitle">是否立即发布</span>
                        <Hi:OnOff runat="server" ID="ooRelease"></Hi:OnOff>
                    </li>

                    <li class="mb_0"><span class="formitemtitle">搜索描述：</span>
                        <Hi:TrimTextBox runat="server" CssClass="form_input_m form-control" ID="txtMetaDescription" placeholder="长度限制在260个字符以内" />
                            <p id="ctl00_contentHolder_txtMetaDescriptionTip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">搜索关键字：</span>
                        <Hi:TrimTextBox runat="server" CssClass="forminput form-control" ID="txtMetaKeywords" placeholder="长度限制在160个字符以内"  />
                            <p id="ctl00_contentHolder_txtMetaKeywordsTip"></p>
                    </li>
                    <li>
                        <span class="formitemtitle">文章图标：</span><div id="imageContainer">
                    ...
                    <li><span class="formitemtitle">摘要：</span>
                        <asp:TextBox ID="txtShortDesc" TextMode="MultiLine" CssClass="form_input_l form-control"  Height="70px" runat="server" placeholder="长度限制在300个字符以内"></asp:TextBox>
