...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
        ...
        <div class="left">
            <asp:Panel ID="Panel1" runat="server" Style="line-height: 35px;">
                <p style="width: 100%; float: left; margin: 10px 0;">
                    ...
                    <Hi:ProductCategoriesDropDownList ID="dropCategories" ClientIDMode="Static" runat="server" Width="160" Height="33" CssClass="iselect" NullToDisplay="请选择商品分类" />
    ...
    <input type="hidden" name="hidCurArticId" id="hidCurArticId" value="<%=articId %>" />
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/comment/ashx/RelatedArticleProduct.ashx" />
    <input type="hidden" name="dataurl2" id="dataurl2" value="/Admin/comment/ashx/RelatedArticleProduct.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/comment/scripts/RelatedArticleProduct.js" type="text/javascript"></script>
</asp:Content>
