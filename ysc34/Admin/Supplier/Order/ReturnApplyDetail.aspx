<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ReturnApplyDetail.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier.Order.ReturnApplyDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function acceptReturn() {
            ...
            if (adminShipAddress == "" && $("#hidAfterSaleType").val() != "3") { ShowMsg("请输入收货地址和联系方式", false); return false; }
            var adminRemark = $("#txtAdminRemark").val();
            return true;
        }
        function refuseReturn() {
            var adminRemark = $("#txtAdminRemark").val();
            if (adminRemark == "") { ShowMsg("请在备注中输入拒绝原因", false); return false; }
            return true;
        }
            ...
            <div class="dingdan_box5">
                <ul>
                    ...
                    <li class="acceptRow returnRow" style="display: none"><b>收货地址：</b>
                        <em>
                            <asp:Literal ID="litAdminShipAddrss" runat="server" Visible="false"></asp:Literal><asp:TextBox ID="txtAdminShipAddress" placeholer="请填写收货地址" runat="server" CssClass="forminput form-control" Width="350" /></em>
                    </li>
                    <li class="acceptRow returnRow" style="display: none"><b>收货人：</b>
                        <em>
                            ...
                            <asp:TextBox ID="txtAdminShipTo" placeholer="请填写收货人" runat="server" CssClass="forminput form-control" Width="350px" /></em>
                    </li>
                    <li class="acceptRow returnRow" style="display: none"><b>收货人电话：</b>
                        <em>
                            <asp:Literal ID="litAdminCellPhone" runat="server" Visible="false"></asp:Literal><asp:TextBox ID="txtAdminCellPhone" placeholer="请填写收货人电话" runat="server" Width="350px" CssClass="forminput form-control" /></em>
                    </li>
