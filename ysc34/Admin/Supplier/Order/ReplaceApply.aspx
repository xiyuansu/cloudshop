<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ReplaceApply.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier.Order.ReplaceApply" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <div class="searcharea">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="button" name="btnSearch" value="导出数据" id="btnSearch" class="btn btn-primary" />
                    </li>
                </ul>
            </div>
            <!--结束-->
    ...
    <!--E Data Template-->
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/Supplier/Order/ashx/ReplaceApply.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/Supplier/Order/scripts/ReplaceApply.js" type="text/javascript"></script>
</asp:Content>
