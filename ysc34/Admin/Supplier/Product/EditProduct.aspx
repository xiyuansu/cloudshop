<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="EditProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier.Product.EditProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
    ...
    <script type="text/javascript" src="../../product/attributes.helper.js"></script>
    <script type="text/javascript" src="../../product/grade.price.helper.js"></script>
    ...
    <div class="dataarea mainwidth databody">
        ...
        <div class="datafrom">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade active in" id="information_c">
                        <div class="info_group">
                            ...
                            <ul class="hidetoggle">
                                ...
                                <li class="clearfix"><span class="formitemtitle">商品简介：</span>
                                    <Hi:TrimTextBox MaxLength="300" runat="server" Rows="6" Height="100px" Columns="76" ID="txtShortDescription" TextMode="MultiLine" CssClass="form-control form_input_l" placeholder="限定在300个字符以内" />
                                </li>
                        ...
                        <div class="info_group">
                            ...
                            <ul>
                                <li id="liSalestatus"><span class="formitemtitle">销售状态：</span>
                                ...
                                <li><span class="formitemtitle"><em>*</em>运费模板：</span>
                                    ...
                                    <a href="../Sales/AddShippingTemplate.aspx" style="display:none" class="input-group-a">&nbsp;&nbsp;新增运费模板</a>
                                </li>
                            ...
                            <ul>
                                ...
                                <li id="salePriceRow" class="mb_0"><span class="formitemtitle"><em>*</em>一口价：</span>
                                    <div class="input-group">
                                        ...
                                        <a href="javascript:;" onclick="editProductMemberPrice();" id="aEidtMemberPrice" class="input-group-a">&nbsp;&nbsp;编辑会员价</a>
                                    </div>
                                ...
                                <li id="costPriceRow"><span class="formitemtitle">成本价：</span>
                                    <div class="input-group">
                                        <span class="input-group-addon">￥</span>
                                        <Hi:TrimTextBox runat="server" ReadOnly="true" CssClass="form-control form_input_s" ID="txtCostPrice" />
                                    </div>
                                </li>
                                ...
                                <li id="qtyRow"><span class="formitemtitle"><em>*</em>商品库存：</span>
                                    <Hi:TrimTextBox runat="server" CssClass="form_input_m form-control" ID="txtStock" ReadOnly="true" />
                                    <asp:Label ID="lblStock" runat="server" Text=""></asp:Label>
                                </li>
                                <li id="warningqtyRow" class="mb_0"><span class="formitemtitle"><em>*</em>警戒库存：</span>
                                    <Hi:TrimTextBox runat="server" CssClass="form_input_m form-control" ID="txtWarningStock"  ReadOnly="true"  Text="0" />
                                    <asp:Label ID="lblWarningStock" runat="server" Text=""></asp:Label>
                                    <p id="ctl00_contentHolder_txtWarningStockTip"></p>
                                </li>
                                <li id="enableSkuRow" style="display: none;"><span class="formitemtitle">规格：</span>
                                    <input id="btnEnableSku" type="button" class="btn btn-primary" value="开启规格" />                                   
                                ...
                                <li id="skuRow" style="display: none; ">
                                    ...
                                    <div class="batch">
                                        <dl>
                                            ...
                                            <dd id="batchMarketPrice"><input type="text" id="txtBatchMarketPrice" class="form-control" placeholder="一口价" /></dd>
                                            <dd id="batchCostPrice"><input type="text" id="txtBatchCostPrice" class="form-control"  placeholder="成本价" /></dd>
                                            <dd id="batchWeight"><input type="text" id="txtBatchWeight" class="form-control"  placeholder="重量/体积" /></dd>
                                            <dd id="batchStore"><input type="text" id="txtBatchStore" readonly="readonly" style="display:none;" class="form-control"  placeholder="库存" /></dd>
                                            <dd id="batchLimitStore"><input type="text" id="txtBatchLimitStore" class="form-control"  style="display:none;" placeholder="警戒库存" /></dd>
                                            <dd id="batchOk"><input type="button" class="btn btn-primary" id="btnBatchOk" value="确定" /></dd>                                                        
                                        </dl>                                     
                                    </div>
            ...
            <div class="footer_btn">
               ...
               <span id="divAudit"> <asp:Button runat="server" ID="btnSaveAudit" Style="display: none" Text="完成并审核通过" OnClick="btnSaveAudit_Click" OnClientClick="return getUploadImages();" CssClass="btn  btn-primary" /></span>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
            ...
            if (attributeId != 0) {
                ...
                $.each(skuValues, function (i, skuValue) {
                    if (selectedSku.indexOf("," + skuValue.ValueId + ",") >= 0) {
                        var valueItem = String.format("<span style='display:inline-block;vertical-align:top;'>{0}：</span><span name='skuImages_{1}' attrId='{2}' class='imgbox' style='display:inline-block'></span>&nbsp;&nbsp;&nbsp;&nbsp;{3}", skuValue.ValueStr, skuValue.ValueId, attributeId, (i + 1) % 3 == 0 ? "<br /><br />" : "");
        ...
        function setcontrol()
        {
            if ($("#ctl00_contentHolder_hidHasActivity").val() == "1") {
               ...
               // $(".batch").hide();
                ...
                $('#btnAddItem').hide();
                $('#txtBatchMarketPrice').attr("disabled",true);
                $('#btnBatchOk').attr("disabled", true);
                $('#batchStore').hide();
                $("#aEidtMemberPrice").removeAttr("onclick");
                $("#aEidtMemberPrice").bind("click", function () { ShowMsg("正在参加活动不能编辑价格", false); return false; });
    ...
    <script src="js/EditSupplierProduct.js?v=1.1"></script>
</asp:Content>
