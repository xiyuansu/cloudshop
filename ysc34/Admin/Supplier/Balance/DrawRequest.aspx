<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DrawRequest.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier.Balance.DrawRequest" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <!--E Data Template-->
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/Supplier/Balance/ashx/DrawRequest.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/Supplier/Balance/scripts/DrawRequest.js" type="text/javascript"></script>
</asp:Content>
