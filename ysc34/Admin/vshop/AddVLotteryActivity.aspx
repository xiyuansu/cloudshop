<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddVLotteryActivity.aspx.cs" Inherits="Hidistro.UI.Web.Admin.vshop.AddVLotteryActivity" %>
            ...
            <div class="columnright">
                <div class="formitem validator2">
                    <ul>
                        ...
                        <Hi:CalendarPanel runat="server" ID="calendarStartDate" Width="175" placeholder="不能为空" ClientIDMode="Static"></Hi:CalendarPanel>
                            <span>&nbsp;&nbsp;至&nbsp;&nbsp;</span>
    ...
    <div id="ddcontent">
                            ...
                            <li class="mb_0 NewItem" id="index1">
                                ...
                                <div class="input-group" style="display:block">
                                    ...
                                    <input type="text" value="0"  id="Counts_1"  placeholder="最大为9999"   class="form_input_xss  form-control" onkeyup="value=value.replace(/[^\d]/g,'')" />
                                </div>
                              
                                <span   style="margin-left: 10px;">概率：</span>
                                <div class="input-group" style="display:block">
                                    <input type="text" value="0" id="Costs_1" class="form_input_xss form-control" placeholder="最大为100" onkeyup="value=value.replace(/[^\d.]/g,'')" />
    ...
    <script type="text/javascript">
        ...
        function getUploadImages() {
            ...
            function InitValidators() {
                ...
                initValid(new InputValidator('txtProbability1', 1, 6, false, "(([0-9]+.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*.[0-9]+)|([0-9]*[1-9][0-9]*))", '请正确输入一等奖中奖概率'));
                initValid(new InputValidator('txtProbability2', 1, 6, false, "(([0-9]+.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*.[0-9]+)|([0-9]*[1-9][0-9]*))", '请正确输入二等奖中奖概率'));
                initValid(new InputValidator('txtProbability3', 1, 6, false, "(([0-9]+.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*.[0-9]+)|([0-9]*[1-9][0-9]*))", '请正确输入三等奖中奖概率'));
            ...
            function GetInvild() {
                ...
                if (hasCount) {
                    $("#ddcontent li").each(function (i) {
                        ...
                        initValid(new InputValidator("Counts_" + num, 1, 4, false, '[0-9]\\d*', '请正确输入奖品数量，最大分数为9999'));
                    });
