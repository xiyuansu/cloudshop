...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="areacolumn clearfix databody">
        <div class="columnright">
            ...
            <div class="formitem validator2 top_10 left_198">
                <ul>
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>活动名称：</span>
                        <asp:TextBox ID="txtName" runat="server" CssClass="forminput form-control" placeholder="不能为空"></asp:TextBox>
                        <p id="ctl00_contentHolder_txtNameTip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>开始时间：</span>
                        <Hi:CalendarPanel runat="server" ID="txtStartDate" placeholder=""></Hi:CalendarPanel>
                        <p id="ctl00_contentHolder_txtStartDateTip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>结束时间：</span>
                        <Hi:CalendarPanel runat="server" ID="txtEndDate" placeholder=""></Hi:CalendarPanel>
                        <p id="ctl00_contentHolder_txtEndDateTip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">人数上限：</span>
                        <asp:TextBox ID="txtMaxValue" runat="server" CssClass="forminput form-control" placeholder="不填写，则无上限"></asp:TextBox>
                    ...
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>活动表单项一：</span>
                        <asp:TextBox ID="txtItem1" runat="server" CssClass="forminput form-control" placeholder=""></asp:TextBox>
                        <p id="ctl00_contentHolder_txtItem1Tip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">表单项二：</span>
                        <asp:TextBox ID="txtItem2" runat="server" CssClass="forminput form-control"></asp:TextBox>
                        <p id="ctl00_contentHolder_txtItem2Tip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">表单项三：</span>
                        <asp:TextBox ID="txtItem3" runat="server" CssClass="forminput form-control"></asp:TextBox>
                        <p id="ctl00_contentHolder_txtItem3Tip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">表单项四：</span>
                        <asp:TextBox ID="txtItem4" runat="server" CssClass="forminput form-control"></asp:TextBox>
                        <p id="ctl00_contentHolder_txtItem4Tip"></p>
                    </li>
                    <li class="mb_0"><span class="formitemtitle">表单项五：</span>
                        <asp:TextBox ID="txtItem5" runat="server" CssClass="forminput form-control"></asp:TextBox>
                    ...
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>关键字：</span>
                        <asp:TextBox ID="txtKeys" runat="server" CssClass="forminput form-control" placeholder="同时作为图文推送的标题来使用"></asp:TextBox>
                ...
                <div class="ml_198">
                    <asp:Button ID="btnAddActivity" runat="server" Text="添加" OnClientClick="return getUploadImages();" CssClass="btn btn-primary" />
                </div>
            </div>
        </div>
    </div>
