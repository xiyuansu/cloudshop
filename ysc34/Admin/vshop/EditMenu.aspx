    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                ...
                <li  class="hover"><a href="javascript:void">修改</a></li>
                ...
                <div class="formitem validator2">
                    <ul>
                        <li class="mb_0"><span class="formitemtitle Pw_100"><em>*</em>菜单名称：</span>
                            <asp:TextBox ID="txtMenuName" runat="server" CssClass="form-control forminput" placeholder="一级菜单五个汉字，二级菜单七个汉字" />
                    ...
                    <div class="ml_198 mt0">
                        <asp:Button ID="btnAddMenu" runat="server" OnClientClick="return PageIsValid();" Text="确 定" CssClass=" Ml_100 btn btn-primary" />
                    </div>
                </div>
            </div>
