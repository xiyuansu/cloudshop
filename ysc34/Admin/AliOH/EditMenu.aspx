<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMenu.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AliOH.EditMenu" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="areacolumn clearfix databody">
        <div class="title">
            <ul class="title-nav">
                <li class="hover"><a href="javascript:void">编辑菜单</a></li>
                <li><a href="ManageMenu.aspx">自定义菜单列表</a></li>
            </ul>
        </div>
            ...
            <div class="formitem validator2">
                <ul>
                    <li class="mb_0"><span class="formitemtitle Pw_100"><em>*</em>菜单名称：</span>
                        <asp:TextBox ID="txtMenuName" runat="server" CssClass="forminput form-control" placeholder="菜单名称不能为空，一级菜单最多4个汉字，二级菜单最多12个汉字。" />
