<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CPCountDownStores.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ChoicePage.CPCountDownStores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <div class="dataarea mainwidth databody">
                ...
                <!--E Pagination-->
                  <div class="modal_iframe_footer">
                    <a href="javascript:void(0)" class="btn btn-primary" onclick="return SelectCountDownStores()">添加</a>
                </div>
            </div>
    ...
    <script src="/admin/promotion/scripts/CountDownStores.js" type="text/javascript"></script>
</asp:Content>
