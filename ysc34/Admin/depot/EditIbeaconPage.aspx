<%@ Page MasterPageFile="~/Admin/Admin.Master" Language="C#" AutoEventWireup="true" CodeBehind="EditIbeaconPage.aspx.cs" Inherits="Hidistro.UI.Web.Admin.depot.EditIbeaconPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtURL', 1, 300, false, '(http)|(https)://.*', '跳转URL必须以http://或者https://开头，长度必须小于或等于300个字符'));
        ...
        function doSubmit() {
            ...
            var thumbnail = $("#ctl00_contentHolder_hficon_url").val();
        ...
        function getUploadImages() {
            ...
            $("#<%=hficon_url.ClientID%>").val(srcLogo);
            return true;
        }
    </script>
    <div class="dataarea mainwidth databody">
        ...
        <div class="datafrom">
            <div class="formitem validator1">
                <ul>
                    <li class="clearfix" class="mb_0"><span class="formitemtitle "><em>*</em>主标题：</span>
                    ...
                    <li class="m_none" ><span class="formitemtitle  m_none"><em>*</em>缩略图：</span>
                        <div id="logoContainer" style="padding-left: 80px">
                            <span name="siteLogo" class="imgbox"></span>
                            <asp:HiddenField ID="hficon_url" runat="server" />
                    ...
                    <li  class="mb_0"><span class="formitemtitle "><em>*</em>跳转URL：</span>
                        <asp:DropDownList ID="ddlSystemUrl" runat="server" CssClass="forminput form-control droptype" Width="100">
                ...
                <ul class="btntf clear">
                    <asp:Button runat="server" ID="btnEdit" Text="保 存" CssClass="Ml_100 btn btn-primary" OnClientClick="return doSubmit();" />
                </ul>
            </div>
        </div>
    </div>
