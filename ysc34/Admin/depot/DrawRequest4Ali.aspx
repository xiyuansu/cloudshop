<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DrawRequest4Ali.aspx.cs" Inherits="Hidistro.UI.Web.Admin.depot.DrawRequest4Ali" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function OpenNewWin(IDList) {
            window.open("/Admin/member/BalanceDrawRequestOnLine.aspx?Ids=" + IDList + "&Type=balance4store", "_blank");
        }
    </script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <!--E Data Template-->
    <input type="hidden" name="dataurl" id="dataurl" value="/Admin/Depot/ashx/DrawRequest4Ali.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Admin/Depot/scripts/DrawRequest4Ali.js" type="text/javascript"></script>
</asp:Content>
