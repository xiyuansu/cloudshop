...
const NO_DATA_MSG = "<div class='dataNull' id='dataNull'><img src='../images/data_null.png'><p>没有找到符合条件的数据!</p></div>";
...
function initQuery(obj) {
    ...
    var page_id = getParam("page_id");
    if (page_id.length>0) {
        obj.page_id = page_id;
    }
    var SearchEquipmentId = $("#txtSearchEquipmentId").val();

    if (SearchEquipmentId.length > 0) {
        obj.SearchEquipmentId = SearchEquipmentId;
    }
    return obj;
}
//参数检测
