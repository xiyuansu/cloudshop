<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddWXStores.aspx.cs" Inherits="Hidistro.UI.Web.Admin.depot.AddWXStores" %>
            ...
            <div class="formitem">
                <ul>
                    ...
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>类目：</span>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:DropDownList ID="ddlCategoryChild" runat="server" CssClass="iselect ml_10"></asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        <p>
                        </p>
                    ...
                    <li>
                        ...
                        <asp:Button runat="server" ID="btnAdd" Text="保 存" OnClientClick="return newdoSubmit();" CssClass="btn btn-primary inbnt" OnClick="btnAdd_Click" />
                    </li>
                </ul>
