<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AppProductSetting.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AppProductSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddProductDiv() {
            ...
            DialogFrameClose("product/SearchProduct?IsIncludeHomeProduct=1", "选择商品", null, null, function (e) { CloseFrameWindow(); });
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
        ...
        <div class="datalist datalist-img">
            ...
            <script id="datatmpl" type="text/html">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width: 60px;" class="form-control txtdisplay" data-oldvalue="{{item.DisplaySequence}}" value="{{item.DisplaySequence}}" data-id="{{item.ProductId}}" /></td>
    ...
    <input type="hidden" name="dataurl" id="dataurl" value="/admin/App/ashx/AppProductSetting.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/admin/App/scripts/AppProductSetting.js" type="text/javascript"></script>
