<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopTempEdit.aspx.cs" Inherits="Hidistro.UI.Web.Admin.App.ShopTempEditNew" %>
...
<body>
    <form id="thisForm" runat="server">
        ...
        <input type="hidden" id="pageclient" value="appshop" />
                ...
                <div class="fl imgnav-info">
                    <div class="formitems">
                        ...
                        <div class="form-controls">
                            ...
                            <#}#>
                            <# if(item.linkType==10||item.linkType==23){ #>
                            ...
                            <# if(item.linkType==10){ #>
                             ...
                             <# } #>
                             <# if(item.linkType==23){ #>
                             <span class="fi-help-text">输入格式为： tel://+电话号码</span>
                             <# } #>
      ...
      <ul class="ctrl-item-list">
       ...
       <ul class="ctrl-item-list">
        ...
        <!-- 线上环境 -->
        <script src="/Admin/shop/Public/js/dist/component-app.js?v=3.32"></script>
