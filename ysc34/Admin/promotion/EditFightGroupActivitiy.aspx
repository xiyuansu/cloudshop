<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditFightGroupActivitiy.aspx.cs" Inherits="Hidistro.UI.Web.Admin.FightGroupActivitiy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selectProduct() {
            ...
            var fightGroupActivityId = "<%= this.Page.Request["fightGroupActivityId"].ToNullString()%>";
            var dataForm = {
            ...
            var url = "/Admin/ChoicePage/CPProducts.aspx?returnUrl=/Admin/promotion/EditFightGroupActivitiy.aspx&fightGroupActivityId=" + fightGroupActivityId + "&formData=" + JSON.stringify(dataForm) + "&isFilterFightGroupProduct=true&isFilterCountDownProduct=true&IsFilterGroupBuyProduct=true&isFilterCombinationBuyProduct=true&isFilterPreSaleProduct=true&isFilterCombinationBuyOtherProduct=true&isFilterPromotionProduct=true&isHasStock=true";
        ...
        $(document).ready(function () {
            ...
            function InitValidators() {
                ...
                if (hasSku) {
                    ...
                    initValid(new InputValidator('ctl00_contentHolder_txtPrice', 1, 10, false, '([0-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，火拼抢购价格只能输入数值,且不能超过2位小数'))
                ...
                <div class="formitem">
                    <ul>
                        ...
                        <li id="liSkus" runat="server"><span class="formitemtitle "><em>*</em>商品规格：</span>
                            <div class="datalist clearfix " style="width: 700px; margin-left: 140px;">
                                <asp:Repeater ID="rptProductSkus" runat="server">
                                    <HeaderTemplate>
                                        <table class="table table-striped mb_0" id="ctl00_contentHolder_grdProducts">
                                            <tbody>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtActivityStock" Text='<%#Eval("FightGroupTotalCount")%>' runat="server" CssClass="forminput form-control" Width="100" onkeyup="value=value.replace(/[^\d]/g,'')"></asp:TextBox>
                                            </td>
                                            <td><%#Eval("SalePrice").ToDecimal().ToString("f2")%></td>
                                            <td>
                                                <asp:TextBox ID="txtActivitySalePrice" Text='<%#Eval("FightGroupSalePrice").ToDecimal().ToString("f2")%>' runat="server" CssClass="forminput form-control" Width="100" onkeyup="value=value.replace(/[^\d.]/g,'')"></asp:TextBox></td>
                                        </tr>
                                    </ItemTemplate>
                        ...
                        <li><span class="formitemtitle "><em>*</em>参团人数：</span>
                            ...
                            <p id="ctl00_contentHolder_txtJoinNumberTip">
                        ...
                        <li><span class="formitemtitle "><em>*</em>成团时限：</span>
                            ...
                            <p id="ctl00_contentHolder_txtLimitedHourTip">
                                开团成功后，团长发起的组团有效时间。
                            </p>
                        </li>
