<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditProductPromotion.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditProductPromotion" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function SelectPromoteType() {
            ...
            if (promoteType == 1) {
                $("#radPromoteType_Discount").iCheck('check');
            }
            else if (promoteType == 2) {
                $("#radPromoteType_Amount").iCheck('check');
            }
            else if (promoteType == 3) {
                $("#radPromoteType_Reduced").iCheck('check');
            }
            else if (promoteType == 4) {
                $("#radPromoteType_QuantityDiscount").iCheck('check');
            }
            else if (promoteType == 5) {
                $("#radPromoteType_SentGift").iCheck('check');
            }
            else if (promoteType == 6) {
                $("#radPromoteType_SentProduct").iCheck('check');
            }
        ...
        function Valid() {
            ...
            if (promoteType == 1) {
                ...
                if ($("#txtGiftNum").val().length == 0 || isNaN($("#txtGiftNum").val()) || parseInt($("#txtGiftNum").val()) < 1) {
                    alert("礼品数量必须是大于0的正整数!");
                    return false;
                }
            }
            else if (promoteType == 6) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="areacolumn">
        <div class="columnright" style="float: left;">
            <div class="datafrom">
                <div class="formitem">
                    <ul>
                        <li class="icheck-label-5-10"  id="promoteli" runat="server"><span class="formitemtitle"><em>*</em>促销活动类型：</span>
                            <Hi:PromoteTypeRadioButtonList IsProductPromote="true" runat="server" IsCanEdit="false" ID="radPromoteType" />
                        ...
                        <li class="mb_0" id="liGiftNum" style="display: none;">
                            <span class="formitemtitle"><em>*</em>礼品数量：</span>
                            <asp:TextBox ID="txtGiftNum" ClientIDMode="Static" runat="server" Text="1" CssClass="forminput form-control" placeholder="礼品数量必须是大于0的正整数"></asp:TextBox>
                            <p id="P1"></p>
                        </li>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <span id="spDiscountValue"><span id="lblDiscountValueTip" class="formitemtitle "></span>
                                        <asp:TextBox ID="txtDiscountValue" runat="server" CssClass="forminput form-control" placeholder="如果打9折，请输入0.9"></asp:TextBox></span></td>
                                </tr>
                            </table>
                        ...
                        <li style="margin-top: 10px;">
                            ...
                            <asp:Button ID="btnNext" runat="server" Text="保存修改" OnClientClick="setChooseGifts();return Valid();" CssClass="btn btn-primary" />
                        </li>
                    </ul>
