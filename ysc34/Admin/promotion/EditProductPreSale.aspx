<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditProductPreSale.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.EditProductPreSale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function ShowProductDiv() {
            DialogFrameClose("product/SearchPreSaleProduct.aspx", "选择预售商品", null, null, function (e) { CloseFrameWindow(); });
        }
        ...
        $(document).ready(function () {
            $("#spanProductPrice").html($("#ctl00_contentHolder_hidSalePrice").val());
            $("#spanProductName").html($("#ctl00_contentHolder_hidProductName").val());
            calcuDeposit();
            InitValidators();
        });
            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <li>
                        ...
                        <span style="color: #999999; margin-left: 20px;" id="spanProductPricetip">商品有多个规格时显示最低价格</span>
                    ...
                    <asp:Button ID="btnAddPreSale" runat="server" Text="确定" OnClientClick="return onPreSaleSave();" CssClass="btn btn-primary ml_198" />
                </ul>
            </div>
        </div>
    </div>
