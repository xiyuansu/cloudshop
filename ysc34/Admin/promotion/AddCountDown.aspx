<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddCountDown.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddCountDown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getUploadImages() {
            ...
            return PageIsValid()&&checkPageData();
        }
            ...
            function InitValidators() {
                ...
                if (hasSku) {
                    $("#ctl00_contentHolder_grdProducts tr:gt(0)").find("[id$=txtActivitySalePrice]").each(function () {
                        ...
                        appendValid(new MoneyRangeValidator($(this).attr("id"), 0.01, 10000000, '输入的数值超出了系统表示范围'));
                    });
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li><a id="aReturn" href="countdowns.aspx">限时抢购</a></li>
            ...
            <div class="columnright">
                <div class="formitem">
                    <ul>
                        ...
                        <li><span class="formitemtitle "><em>*</em>商品名称：</span>
                        ...
                        <li id="liDefaultTotalCount" runat="server" class="mb_0"><span class="formitemtitle "><em>*</em>活动库存：</span>
                            <asp:TextBox ID="txtTotalCount" runat="server" CssClass="forminput form-control" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="必须小于商品当前库存数"></asp:TextBox>
                        ...
                        <li id="liScope" style="display:none;">
                            ...
                            <span id="chooseStoreTC">
                            <input type="button" value="选择门店" onclick="ShowTags();" /></span>
                            <span>已选门店&nbsp;&nbsp;&nbsp;<em id="divCount">0</em>&nbsp;个</span>
                        </li>
                        <li>
                            <span class="formitemtitle ">活动说明：</span>
                            <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Columns="50" Rows="5" CssClass="form_input_l form-control" Width="500" Height="100" placeholder="不超过300个字"></asp:TextBox>
                        </li>
                        <li>
                            <span class="formitemtitle ">分享标题：</span>
                            <asp:TextBox ID="txtShareTitle" runat="server" CssClass="form_input_l form-control" MaxLength="100" placeholder="不超过100个字"></asp:TextBox>
                        </li>

                        <li>
                            <span class="formitemtitle ">分享内容：</span>
                            <asp:TextBox ID="txtShareDetails" TextMode="MultiLine" runat="server" CssClass="form_input_l form-control" Width="500" Height="100" placeholder="不超过500个字"></asp:TextBox>
                        </li>
                    ...
                    <div class="ml_198">
                        <asp:Button ID="btnAddCountDown" runat="server" Text="添加" CssClass="btn btn-primary" OnClientClick="return getUploadImages();" />
                    </div>
                </div>
            </div>
        </div>
