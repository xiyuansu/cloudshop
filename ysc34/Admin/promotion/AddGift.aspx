                ...
                <div class="formitem ">
                    <ul>
                        ...
                        <li><span class="formitemtitle"><em>*</em>礼品名称：</span>
                            <asp:TextBox ID="txtGiftName" runat="server" CssClass="form_input_l form-control" placeholder="不超过60个字符"></asp:TextBox>
                        </li>

                        <li><span class="formitemtitle"><em>*</em>礼品图片：</span>
                        ...
                        <li class="clearfix"><span class="formitemtitle">计量单位：</span>
                            <asp:TextBox ID="txtUnit" runat="server" CssClass="form_input_m form-control" placeholder="不超过10个字符"></asp:TextBox>
                        </li>
                        <li><span class="formitemtitle">成本价：</span>
                            <div class="input-group">
                                <span class="input-group-addon">￥</span>
                                <asp:TextBox ID="txtCostPrice" runat="server" CssClass="form_input_s form-control" placeholder=""></asp:TextBox>
                            </div>
                        </li>
                        <li><span class="formitemtitle">市场参考价：</span>
                            <div class="input-group">
                                <span class="input-group-addon">￥</span>
                                <asp:TextBox ID="txtMarketPrice" runat="server" CssClass="form_input_s form-control" placeholder=""></asp:TextBox>
                            </div>
                        </li>
                        <li>
                        ...
                        <li id="lipoint" style="display:none;">
                        ...
                        <li id="volumeRow" style="display: none;"><span class="formitemtitle"><em>*</em>商品体积：</span>
                            <div class="input-group">
                                <Hi:TrimTextBox runat="server" CssClass="form_input_s form-control" ID="txtVolume" Text="" placeholder="请输入数字,限制为0-100000" ClientIDMode="Static" />
                        ...
                        <li><span class="formitemtitle">简单介绍：</span>
                            <asp:TextBox ID="txtShortDescription" runat="server" TextMode="MultiLine" Width="450px" Height="70px" CssClass="form_input_l form-control" placeholder="不超过300个字符"></asp:TextBox>
                        </li>
                        <li><span class="formitemtitle">详细信息：</span>
                            <Hi:Ueditor ID="fcDescription" runat="server" Width="660" CssClass="fl" />
                        </li>
                        <li class="h2_100">
                            <h2>SEO设置</h2>
                        </li>
                        <li><span class="formitemtitle">详细页标题：</span>
                            <asp:TextBox ID="txtGiftTitle" runat="server" CssClass="form_input_l form-control" MaxLength="100" placeholder="不超过100个字符"></asp:TextBox>
                        </li>
                        <li><span class="formitemtitle">详细页关键字：</span>
                            <asp:TextBox ID="txtTitleKeywords" runat="server" CssClass="form_input_l form-control" MaxLength="160" placeholder="不超过160个字符"></asp:TextBox>
                        </li>
                        <li><span class="formitemtitle">详细页描述：</span>
                            <asp:TextBox ID="txtTitleDescription" runat="server" CssClass="form_input_l form-control" MaxLength="260" placeholder="不超过260个字符"></asp:TextBox>
                        </li>
                    </ul>
                </div>
                <div class="ml_198">
                    <asp:Button ID="btnCreate" runat="server" Text="添加" OnClientClick="return getUploadImages();" CssClass="btn btn-primary" />
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function InitValidators() {
            initValid(new InputValidator('ctl00_contentHolder_txtGiftName', 1, 60, false, null, '礼品名称不超过60个字符'))
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtNeedPoint', 1, 10, false, '-?[0-9]\\d*', '兑换所需积分只能是数字，必须大于0'))
