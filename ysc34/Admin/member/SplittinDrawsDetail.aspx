<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SplittinDrawsDetail.aspx.cs" Inherits="Hidistro.UI.Web.Admin.SplittinDrawsDetail" %>
    ...
    <div class="areacolumn clearfix">
        <div class="columnright">
            <div class="formitem_con">
                ...
                <%}
                    if (!isAlipay && !isWeixin && !isWithdrawToAccount)
                    { %>
                ...
                <%} %>
                <span class="formitemtitle" style="width: 80px;">提现金额：</span>
                <asp:Label runat="server" ID="lblMoney" Text=""></asp:Label><br />
                <span class="formitemtitle" style="width: 80px;">提现备注：</span>
                <asp:Label runat="server" ID="LabRemark" Text=""></asp:Label><br />
            </div>
