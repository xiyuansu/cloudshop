...
function initQuery(obj) {
    ...
    var IsRepeled = $("#chkIsRepeled").attr("checked");
    if (IsRepeled == "checked") {
        obj.IsRepeled = true;
    } else {
        obj.IsRepeled = false;
    }
    ...
    obj.GradeId = $("#dropGradeList").val();
    obj.SortBy = $("#dropSortBy").val();
...
function Post_ExportExcel() {
    ...
    var url =  "/admin/member/ashx/MemberManage.ashx" + "?";
