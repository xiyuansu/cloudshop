...
function Post_SaveTag() {
    var id = $("#hidTagId").val();
    var TagName = $("#txtTagName").val();
    var OrderCount = $("#txtOrderCount").val();
    var OrderTotalAmount = $("#txtOrderTotalAmount").val();
    var canoper = true;
    if (canoper) {
        var pdata = {
            TagName: TagName, OrderCount: OrderCount, OrderTotalAmount: OrderTotalAmount,
            id: id, action: "SaveTag"
        }
        var loading;
        try {
            loading = showCommonLoading();
