...
function ShowUnLineReCharge(opers, id, UserName, BankName, AccountName, MerchantCode) {
    ...
    DialogShow(opers, 'balancedrawrequest', 'divunlinerecharge', 'ctl00_contentHolder_btnRequest');
}
function ShowRefuseRequest(opers, id, UserName) {
    ...
    DialogShow(opers, 'balancedrawrequest', 'divrefuserequest', 'ctl00_contentHolder_btnRequest');
}
