<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManualPush.aspx.cs" Inherits="Hidistro.UI.Web.Admin.member.ManualPush" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server" ClientIDMode="Static">
    ...
    <asp:HiddenField runat="server" ID="hidUserIds" Value="" ClientIDMode="Static" />
            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <%--<li>
                        ...
                        <asp:Label runat="server" ID="lblSendUserNames"></asp:Label>
                    </li>
                    <li>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#btnSelectTopic").bind("click", function () {
                ...
                DialogFrame(url, "选择移动端专题", 800, 550, function (e) { location.reload(); })

            });
            $("#btnSelectProduct").bind("click", function () {
                var url = setControlByPushType($("[name$=rblPushType]:checked"));
                DialogFrame(url, "选择商品", 800, 550, function (e) { location.reload(); })
            });
        })

        function setControlByPushType(pushTypeControl) {
            var data = {
                PushType: $("[name$=rblPushType]:checked").val(), PushTitle: $("#txtPushTitle").val(), SendUserIds: $("#hidUserIds").val(), PushContent: $("#txtPushContent").val(), PushUrl: $("#txtURL").val()
            };
            var url = "";
            ...
            switch (value) {
                case 1:
                    ...
                    break;
                case 2:
                    url = "/Admin/ChoicePage/CPTopicList.aspx?returnUrl=/Admin/member/ManualPush.aspx&formData=" + JSON.stringify(data);
                ...
                case 4:
                    ...
                    url = "/Admin/ChoicePage/CPProducts.aspx?returnUrl=/Admin/member/ManualPush.aspx&formData=" + JSON.stringify(data);
                    break;
            }
            return url;
