            ...
            <div class="formitem">
                <ul>
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>会员等级名称：</span>
                        <asp:TextBox ID="txtRankName" CssClass="form_input_m form-control" runat="server" placeholder="长度限制在20字符以内" />
                    ...
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>会员等级价格：</span>
                        <div class="input-group">
                            <span class="mr5 c-666">一口价  ×</span>
                            <asp:TextBox ID="txtValue" CssClass="form_input_s form-control radius-3" placeholder="等级折扣不能为空，且是数字" runat="server" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="Server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtValue', 1, 3, false, '-?[0-9]\\d*', '等级折扣为不能为空，且必须为1-999的整数'));
