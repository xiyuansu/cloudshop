<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddReferralGrade.aspx.cs" Inherits="Hidistro.UI.Web.Admin.member.AddReferralGrade" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li>
                    <a href="ReferralGrades.aspx">管理</a></li>
