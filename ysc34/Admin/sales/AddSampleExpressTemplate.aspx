...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        ...
        <div class="datalist clearfix">
            <table width="100%" id="controls" height="56" border="0" cellpadding="0" cellspacing="0" style="text-align: center; border: 1px #CCC solid; background-color: #E7E7E7; font-size: 12px; padding: 0px; margin: 0px 0px 5px 0px;">
                <tr>
