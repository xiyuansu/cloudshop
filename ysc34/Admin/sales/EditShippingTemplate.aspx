<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
     CodeBehind="EditShippingTemplate.aspx.cs" Inherits="Hidistro.UI.Web.Admin.sales.EditShippingTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function InitValidators() {
            initValid(new InputValidator('ctl00_contentHolder_txtModeName', 1, 20, false, null, '配送方式名称不能为空，长度限制在20字符以内'))
        ...
        function IsFlagDate() {
            ...
            if (fagtxtAddRegionPrice.length <= 0 || fagtxtAddRegionPrice.length > 10) { alert("加价必须为非负整数,限制在1000万以内!"); return false; }
                ...
                var reg = /^[0-9]+([.]{1}[0-9]{1,2})?$/; if (!reg.test(fagtxtAddRegionPrice)) { alert("加价必须为非负整数,限制在1000万以内"); return false; }
            }
            return true;
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <div class="formitem">
                <ul>
                    <li class="mb_0"><span class="formitemtitle"><em>*</em>模板名称：</span>
                        <asp:TextBox ID="txtModeName" runat="server" class="form_input_l form-control" placeholder="长度限制在60字符以内"></asp:TextBox>
                        ...
                        <table class="table table-bordered table-area-freight" id="regionFreight">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th nowrap="nowrap" nowrap="nowrap" style="width:87px;">续<span name="ValuationUnitDesc" class="nofloat">件</span>（<span name="ValuationUnit" class="nofloat">件</span>）</th>
    ...
    <script src="../js/FreightTemplateController.js?v=3.3"></script>
