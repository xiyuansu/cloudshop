<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="BatchPrintData.aspx.cs" Inherits="Hidistro.UI.Web.Admin.sales.BatchPrintData" %>
...
<%--        <div class="title  m_none td_bottom" style="padding: 5px 0px 5px 12px">
        ...
        <div class="datafrom" style="padding-bottom: 1px;">
            ...
            <asp:Panel runat="server" ID="pnlEmptySender">
                <span style="color:#0074bb;">您还没有添加发货人信息，请先去【订单】-【快递单管理】-【发货人信息管理】添加发货人信息!</span>
            </asp:Panel>
        </div>
            ...
            <asp:Panel runat="server" ID="pnlTemplates">
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="PrintDataTable">
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" ID="btnPrint"   CssClass="printSub btn btn-primary" Text="打印" OnClientClick="return DoPrint();" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
