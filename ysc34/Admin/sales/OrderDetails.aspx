...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetLogisticsInformation() {
            var orderId = $("#ctl00_contentHolder_hidOrderId").val();           
    ...
    <div class="dataarea mainwidth databody">
        <div class="alert alert-order" role="alert">
            ...
            <div class="btn-group-order">
                ...
                <a id="lbtnViewLogistics" runat="server" href="javascript:GetLogisticsInformation();" visible="false" class="btn btn-default">物流跟踪</a>
        ...
        <div class="tab-content  oder_tab">
            <div role="tabpanel" class="tab-pane active" id="oderinformation">
                ...
                <ul class="buyer_information">
                    ...
                    <li id="ShipAddressService" runat="server" style="width: 100%;"><span>收货信息：</span><asp:Literal ID="lblShipAddress" runat="server" /></li>
                    <li id="ShipToDateNoneService" runat="server" style="width: 100%;"><span>送货时间：</span><asp:Literal ID="litShipToDate" runat="server" /></li>
                    <li style="width: 100%;"><span>买家备注：</span><asp:Label ID="litRemark" runat="server" Style="word-wrap: break-word; word-break: break-all;width:auto;" /></li>
                </ul>
                ...
                <asp:Repeater ID="orderInputItem" OnItemDataBound="Repeater1_ItemDataBound" runat="server" Visible="false">
                    <HeaderTemplate>
                        <table class=" table_one" style="float: left; width: 100%; margin-top: 10px; font-size: 14px; color: #666; border-top: 1px solid #ccc;">
                            <tbody>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr id="trGroup" runat="server">
                            <td width="80" align="right" style="white-space: nowrap;">
                                <%# Eval("InputFieldTitle") %><%# Eval("InputFieldTitle").ToNullString()==""?"":"：" %>
                            </td>
                            <td>
            ...
            <div class="clear"></div>
            <asp:Repeater ID="orderVerificationItem" runat="server" Visible="false">
                <HeaderTemplate>
                    <table class="table table-striped" style="margin-top: 20px; float: left;">
                        <tbody>
                            <tr>
                                <th style="padding-left: 10px;">商品核销码</th>
                                <th>有效期 </th>
                                <th>核销店铺 </th>
                                <th>核销人 </th>
                                <th>核销时间 </th>
                ...
                <ItemTemplate>
                    <tr>
                        <td width="15%">
                            <%# GetVerificationPassword(Eval("VerificationPassword"),Eval("VerificationStatus"))%>
                        </td>

                        <td width="20%">
                            <%# GetValidDate(Eval("ValidStartDate"),Eval("ValidEndDate"),Eval("IsValid"))%>
                        </td>
                        <td><%# Eval("StoreName") %></td>
                        <td><%# Eval("UserName") %></td>
                        <td><%# Eval("VerificationDate") %></td>
                        <td><%# Hidistro.Entities.EnumDescription.GetEnumDescription((Hidistro.Entities.Orders.VerificationStatus)Eval("VerificationStatus")) %></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowRemarkOrder() {
            arrytext = null;
            formtype = "remark";
            DialogFrame('sales/OrderRemark.aspx?OrderId=' + $("#txtOrderId").val(), '修改订单备注', 550, 350, function (e) {
        ...
        function ShowEditAddress() {
            DialogFrame('sales/ShippAddress.aspx?action=update&OrderId=' + $("#txtOrderId").val(), '修改收货地址', 600, 400, function (e) {
                document.location.reload();
            });
        }
