...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
            ...
            <asp:Repeater ID="repOrderGoods" runat="server">
                ...
                <ItemTemplate>
                    <tr class="td_bg">
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtShippOrderNumber" CssClass="forminput form-control" Text='<%# Eval("ShipOrderNumber") %>' placeholder="不能为空" /></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </table>
        ...
        <div class="modal_iframe_footer">
            <asp:Button runat="server" ID="btnBatchSendGoods" Text="批量发货" OnClientClick="return CheckSendGoods();" CssClass="btn btn-primary" />
        </div>
    </div>
