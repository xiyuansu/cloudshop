...
$(function () {
    ...
    HiShop.Config.AjaxUrl = {
        ...
        addImg: "/Utility/Ueditor/net/controller.ashx?action=uploadtemplateimage",//上传图片
        ...
        pageRecover: "/Admin/shop/api/Hi_Ajax_ResetTemplate.ashx",//还原模板
        getPage: "/Admin/shop/api/Hi_Ajax_GetTemplateByID.ashx",//获取模板（用户店铺） 
        /*页面操作相关  end*/
        Coupons: "/Admin/shop/api/Hi_Ajax_Coupons.ashx",//优惠劵
        ...
        /*商品专题*/
        topicsUrl: "/Admin/shop/api/Hi_Ajax_GetTopics.ashx",
        /*选择文章*/
        ArticleList: "/Admin/shop/api/Hi_Ajax_GetArticle.ashx",
    }

    HiShop.Config.CodeBehind = {
        /*解析商品分组数据接口*/
        getGoodGroupUrl: "/Admin/shop/api/Hi_Ajax_GoodsListGroup.ashx",//解析商品分组  
        /*解析商品数据接口*/
        getGoodUrl: "/Admin/shop/api/Hi_Ajax_GoodsList.ashx"//解析商品 
