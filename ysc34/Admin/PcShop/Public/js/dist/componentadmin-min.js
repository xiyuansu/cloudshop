...
HiShop.popbox.CouponListPicker = function (a, b) {
    ...
    var c, d, e = tpl_popbox_CouponListPicker(),
    f = $(e),
    g = [],
    h = [],
    i = function (a, b) {
        var d = function (a) {
            if (c = a.list, c && c.length) {
                var d = tpl_popbox_CouponListPicker_graphicsitem(),
                e = _.template(d)({
                    dataset: c
                }),
                j = $(e);
                    ...
                    onOpen: function (b) {
                        ...
                        function (a) {
                            ...
                            e = function (a, i) {
                                ...
                                var j = function (a) {
                                    if (c = a.list, c && c.length) {
                                        var b = tpl_popbox_CouponListPicker_graphicsitem(),
                                        d = _.template(b)({
                                            dataset: c
                                        }),
                                        j = $(d);
...
HiShop.popbox.TopicsPicker = function (a, b) {
    ...
    var c, d, e = tpl_popbox_TopicsPicker(),
    f = $(e),
    g = [],
    h = [],
    i = function (a, b) {
        var d = function (a) {
            if (c = a.list, c && c.length) {
                var d = tpl_popbox_TopicsPicker_graphicsitem(),
                e = _.template(d)({
                    dataset: c
                }),
                j = $(e);
...
HiShop.popbox.dplPickerColletion = function (a) {
    ...
    switch (parseInt(c.linkType)) {
        ...
        case 2:
            var d = {
                title: "分类导航",
                link: "/" + clientName + "/ProductSearch.aspx"
            };
            c.callback(d, 2)
            break;
        case 3:
        ...
        case 7:
            var d = {
                title: "会员主页",
                link: "/" + clientName + "/MemberCenter.aspx"
            };
            c.callback(d, 7);
            break;
        case 8:
            var d = {
                title: "购物车",
                link: "/" + clientName + "/ShoppingCart.aspx"
            };
            c.callback(d, 8);
            break;
        case 9:
        ...
        case 19:
            var d = {
                title: "火拼团",
                link: "/VShop/FightGroupActivities.aspx"
            };
            c.callback(d, 19);
            break;
        case 20:
            var d = {
                title: "周边门店",
                link: "/" + clientName + "/StoreList.aspx"
            };
            c.callback(d, 20);
            break;
    }
...
// 错误或成功提醒方法
///////////////////////////////////////////////////////////////////////////////////
function HiTipsShow(msg, type, callBack) {
    switch (type) {
        case "success":
        ...
        case "error":
            ...
            var tips = '<div class="modal fade in" id="' + divID + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"><div class="modal-dialog"><div class="alert alert-danger" style="text-indent:20px;position: relative;"><i style="display:block;width:18px;height:18px;background:url(/admin/images/false.gif) no-repeat;position:absolute;left:10px; top:18px;"></i>' + msg + '<a href="#" class="close" data-dismiss="modal" aria-hidden="true" style="position: absolute; top: 2px; right: 7px;">&times;</a></div></div></div>';
            $(document.body).append(tips);
            $('#' + divID).modal('show');
        ...
        case "warning":
            ...
            if (document.getElementById(divID)) { $("#" + divID).remove(); }
            var tips = '<div class="modal fade in" id="' + divID + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"><div class="modal-dialog"><div class="alert alert-warning" style="text-indent:20px;position: relative;"><i style="display:block;width:18px;height:18px;background:url(/admin/images/warning.gif) no-repeat;position:absolute;left:10px; top:18px;"></i>' + msg + '<a href="#" class="close" data-dismiss="modal" aria-hidden="true" style="position: absolute; top: 2px; right: 7px;">&times;</a></div></div></div>';
            $(document.body).append(tips);
