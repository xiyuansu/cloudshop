...
HiShop.Constant = HiShop.Constant ? HiShop.Constant : {},
    ...
    HiShop.popbox.CategoriesPicker = function (a, b) {
        ...
        else if (strUrl.indexOf("pctopictempedit") > -1) {
            clientName = "pctopic";
        }
    ...
    HiShop.popbox.BrandsPicker = function (a, b) {
        var clientName = ($(this), $("#pageclient").val());
        ...
        Win = {
            ...
            a.albums = function (c) {
                ...
                f.fadeIn("fast"),
                    ...
                    f.on("change", ".iselect_one", function () {
