$(function () {
    ...
    HiShop.DIY.Unit.getData = function () {
        ...
        data.page.backgroundColor = $(".backgroundColor").val();
        data.page.backgroundImg = $("#hidUploadImages").val();
        data.page.fillingMethod = $("input[name='repeat']:checked").val();
        data.page.bgAlign = $("input[name='position']:checked").val();
 ...
 * 获取装修数据APP端
 */
    HiShop.DIY.Unit.getData.App = function () {
        HiShop.DIY.reCalcPModulesSort(); //重新计算模块的排序
