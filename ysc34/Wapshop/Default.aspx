...
<head>
    ...
    <script type="text/javascript">
        ...
        function restartPosition() {          
            ...
            if (fromsource != "1" && fromsource != "2" && isOpenMultStore == "1" && hasPosition != "1" && $("#hidIsToPlatform").val().toLowerCase() != "platform") {
                ...
                if (geolocation) {
                    ...
                    if ($("#hidIsToPlatform").val().toLowerCase() != "platform")
     ...
     .members_nav1 li.board6{ width: 50%; border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea; height: 90px;}
         .members_nav1 li.big1_img{ width: 50%;border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;height: 87px;}
        ...
        .members_nav1 ul li.mid1_img {
            width:39.9%;
            border-top: 1px solid #e7e5ea;
            border-right: 1px solid #e7e5ea; overflow:hidden;
        }

        .members_nav1 ul li.small_img {
            width:30%; height:76px; 
            border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;
        }
        ...
        .members_nav1 ul li.small1_img {
            width:30%;
            border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea; overflow:hidden;
        }
...
<body onLoad="restartPosition()">
    ...
    <div class="membersbox">
        ...
        <Hi:HomePage runat="server" ID="H_Page" ClientType="WAP"></Hi:HomePage>
    ...
    <link rel="stylesheet" href="/templates/common/style/index.css?v=3.2" type="text/css" />
    <link rel="stylesheet" href="/templates/common/style/css.css?v=3.2" type="text/css" />

    <script type="text/javascript" src="/templates/common/script/main.js?v=3.4"></script>
