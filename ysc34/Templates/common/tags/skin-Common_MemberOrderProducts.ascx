        ...
        <ItemTemplate>
            <div class="step2">
                <div id="divSupplier" runat="server" class="stitle">
                    ...
                    <div class="SendRedEnvelopeHeard_1" runat="server" id="divSendRedEnvelope" visible="false">
            ...
            <asp:Repeater ID="listOrderItems" runat="server">
                <ItemTemplate>
                    <li>
                        ...
                        <div class="refund">
                            <a runat="server" href="javascript:void(0)" visible="false" id="lkbtnItemStatus" onclick="AfterSaleDetial(this)"></a>
