...
$(function () {
  //  $("#stores .pic").height($("#stores .pic").width());
    ...
    $('.beijing').css({ 'background': beijingBG, 'background-size': '100% auto' });
    $("#stores .intro .storename").css({ 'line-height': $("#stores .pic").width()+'px'});
    ...
    $(".btn_more").click(function (a) {
        $(".wx_aside_item").fadeToggle(300);

        $(document).click(function () {
            $(".wx_aside_item").fadeOut(300);
        })
        a.stopPropagation();
    })
