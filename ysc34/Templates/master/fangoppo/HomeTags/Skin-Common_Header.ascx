...
<body>
    ...
    <div id="header">
		<div class="top-nav">
            <div class="w1200">
                <div class="top-left float-l"><Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" /></div>
                <Hi:Common_SetDeliveryRegion ID="setDeliverRegion" OnlyShowInDefault="true" runat="server"></Hi:Common_SetDeliveryRegion>
                <div class="top-phone float-r"><Hi:Common_CustomAd runat="server" AdId="32" />  </div>                 
                <div class="top-right float-r">
                    ...
                    <span style="display:none;"><li>
                                <Hi:Common_AppDownloadQRCode ID="Common_AppDownloadQRCode1" runat="server" /></li>|</span> <span style="display:none;"><a id="id_c" href="javascript:void(0)">切换繁体</a></span>
        ...
        <div class="w1200 pt20 pb20 o-hidden c-both">
			...
			<div class="float-r">
                <div class="search">
                    <Hi:Common_Search SkinName="/HomeTags/Common_Search/Skin-Common_Search2.ascx" ID="Common_Search" runat="server" />
                </div>
                <div class="hot-key">
                    <em>热门关键字：</em>
                ...
                <div class="nav-l" >
                      <div class="all float-l">
                          ...
                          <div class="my_left_category float-l">
                              <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="13" runat="server" />
                          </div>
                      </div>
