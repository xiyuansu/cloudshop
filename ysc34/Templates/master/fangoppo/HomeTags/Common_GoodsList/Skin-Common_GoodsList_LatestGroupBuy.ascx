...
<asp:Repeater ID="regroupbuy" runat="server">
    <ItemTemplate>
        <div class="group-img">
            <Hi:ProductDetailsLink ID="ProductDetailsLink2" runat="server"  ProductId='<%# Eval("ProductId") %>' ImageLink="true" href='<%#"/GroupBuyProductDetails.aspx?groupBuyId="+ Eval("GroupBuyId") %>'><Hi:ListImage ID="HiImage1" runat="server" DataField="ThumbnailUrl220" IsDelayedLoading="true" 
                Width="214px" Height="198px"/></Hi:ProductDetailsLink>
        </div>
        <img class="bg-pic" data-url="/Templates/master/default/images/common/dis-pic.gif">
        <div class="pro-info">
            <div class="pro-name">
