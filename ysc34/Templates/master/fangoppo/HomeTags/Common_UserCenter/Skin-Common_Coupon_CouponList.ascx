...
<tr class="ddgl_1">
    <td align="center" style="border-right: 1px solid #ddd !important;">
        <%# Eval("CouponName") %>
    <td align="center">
        <%# Eval("Price").ToDecimal().ToString("F2")%>
    </td>
    <td align="center">
    ...
    <td align="center">
        <%# Eval("OrderUseLimit").ToDecimal() == 0 ? "无限制" : "订单满" + Eval("OrderUseLimit").ToDecimal().ToString("F2") + "元使用" %></td>
    <td align="center">
