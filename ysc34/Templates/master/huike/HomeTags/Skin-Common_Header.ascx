...
<body>
    ...
    <div id="header">
        ...
        <div class="top2">
            ...
            <div class="logoad">
                <span><a href="/"><span>首页</span></a></span>
                <span id="denglu2"><a class="feilei1" href='#'>全部商品分类</a>
                    <ul class="tanchu">
                        <Hi:Common_ProductCategoryList TemplateFile="/ascx/tags/Skin-Common_ProductCategoryList2.ascx" runat="server" />
                    </ul>
            ...
            <div class="buycart float-r">
                ...
                <a href="/ShoppingCart.aspx">
                    ...
                    <a class="qujiesuan" href='/ShoppingCart'>去结算</a></div>
            </div>
        </div>
