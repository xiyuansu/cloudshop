...
<asp:Repeater runat="server" ID="recordsone">
     <ItemTemplate>
		...
		<div id='<%# "twoCategory_" + Eval("CategoryId")%>' class="h2_cat"  >
		    <h3><div class="gouxiaos"> <em><img class="size" src="<%#Eval("Icon") %>" /> </em> <a href='<%# RouteConfig.SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a> <span>></span>
            </div>
              <div class="gunjianzi">
