...
<body>
    ...
    <div id="header">
        ...
        <div class="w1200 pt20 pb20 o-hidden c-both">
            ...
            <div class="myuser float-r">
                <em></em><a href="/user/UserDefault.aspx">我的帐户</a>
            </div>
        </div>
        <div class="nav1">
                ...
                <div class="nav-l">
                    <div class="all float-l">
                        ...
                        <div class="my_left_category float-l">
                            <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="5" runat="server" SkinName="/hometags/Skin-CategoriesWithWindow.ascx" />
                        </div>
                    </div>
                    ...
                    <div class="custom1 float-r">
                        <Hi:Common_CustomAd runat="server" AdId="4" />
                    </div>
                </div>
            </div>
