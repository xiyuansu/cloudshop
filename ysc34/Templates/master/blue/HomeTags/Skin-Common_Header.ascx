...
<div class="site-nav">
  <div class="site-nav-bd">
    <ul class="site-nav-bd-l">
      <li class="menu"><Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" DafaultText="尊敬的游客，您好！欢迎来到HISHOP商城"/></li>
       <li class="menu" style="display:none;"><Hi:Common_SetDeliveryRegion ID="setDeliverRegion" OnlyShowInDefault="true" runat="server"></Hi:Common_SetDeliveryRegion></li>
    </ul>
  <div class="fr top1_r">
    <ul class="site-nav-bd-r">
      <li><Hi:Common_MyAccountLink ID="linkMyAccount" runat="server" /></li>                       
      <li id="liLinkLogin"><Hi:Common_LoginLink ID="Common_Link_Login1" runat="server" /></li>
      <li class="fore3"><Hi:Common_VshopQRCode ID="Common_VshopQRCode1" runat="server" /></li>
      <li class="menu"><a href="/user/userorders">我的订单</a></li>
      <li class="menu"><a href="/helps.aspx"/>客户服务</a></li>
      <li class="menu"><a href="/Articles.aspx">商城资讯</a></li>
      <li class="menu" style="display:none;"><a id="id_c" href="javascript:void(0)">切换繁体</a></li>
      <li class="menu">关注：</li>
      <li class="menu"><Hi:Common_CustomAd AdId="52" runat="server" /></li>
      <li class="menu">
...
<div class="site-head">
  <div class="site-head-bd">
    <div class="site-head-bd-l">
      <div class="logo">
        <h1> <Hi:Common_Logo ID="Common_Logo1" runat="server" /></h1>
      </div>
      <div class="float-l"><Hi:Common_ImageAd AdId="51" runat="server" /></div>
    </div>
    <div class="site-head-bd-r">
...
<div class="main-nav">
  <div class="main-nav-bd">
    <div class="main-nav-bd-l all">
      <h2> 全部商品分类</h2>
      <div class="my_left_category">
        <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="7" runat="server" SkinName="/hometags/Skin-CategoriesWithWindow.ascx"/>
      </div>
    </div>
    <div class="main-nav-bd-r" id="ty_menu_title">
      <ul>
