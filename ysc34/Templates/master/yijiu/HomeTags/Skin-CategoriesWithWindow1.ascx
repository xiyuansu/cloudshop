...
<asp:Repeater runat="server" ID="recordsone">
     <ItemTemplate>
		...
		<div id='<%# "twoCategory_" + Eval("CategoryId")%>' class="h2_cat"  >
		    <h3> <div class="gouxiaos"><em><asp:Literal ID="Literal1" runat="server" Text='<%#Eval("Notes5")%>'  /></em> <a href='<%# RouteConfig.SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a></div> 
            <div class="gunjianzi"><asp:Repeater runat="server" ID="repMainTow">
                        <ItemTemplate>
				    ...
				    <div class="shadow_border">
					        ...
					        <span  class="brand" >
                               ...
                               <asp:Repeater runat="server" ID="recordsbrands">
                                    <ItemTemplate>
                                        <a href='<%# GetRouteUrl("branddetails", new { brandId = Eval("BrandId") })%>'>
                                    <img src='<%#Eval("Logo") %>' />
                                </a>                        
                                    </ItemTemplate>
                               </asp:Repeater>
