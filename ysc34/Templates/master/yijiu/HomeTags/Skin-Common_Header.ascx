    ...
    <div id="header">
        <div class="top-nav">
            ...
            <div class="w1200">
                    ...
                    <div class="top-phone float-r" style="display:none;"><Hi:Common_ImageAd runat="server" AdId="2" /></div>
        ...
        <div><Hi:Common_CustomAd runat="server" AdId="5" /></div>
        ...
        <div class="w1200 pt20 o-hidden c-both">
            ...
            <div class="logoad">
              <Hi:Common_ImageAd runat="server" AdId="6" />
            </div>
            <div class="float-l">
                <div class="search">
                ...
                <div class="nav-l w1200" >
                      <div class="all float-l">
                          ...
                          <div class="my_left_category float-l">
                              <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="5" runat="server" SkinName="HomeTags/Skin-CategoriesWithWindow1.ascx" />
                          </div>
                      </div>
                      ...
                      <div class="gouwuchemeun"> <a href="/shoppingcart.aspx"><Hi:Common_ShoppingCart_Info ID="Common_ShoppingCart_Info1" runat="server" /> </a> <a href="/shoppingcart.aspx"  class="qujiesuan">去结算</a> </div> 
                </div>
        </div>
