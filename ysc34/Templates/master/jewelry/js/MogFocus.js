...
(function($){
	$.fn.mogFocus = function(options){
		...
		return this.each(function(){
			...
			opt.scrollWidth == "100%" || opt.scrollWidth == "auto" ? $btn.css(opt.thumCSS) : $btn.css("right",'10%');
	...
	$.fn.mogFocus.defaults = {
		...
		thumSubsty : {"background":"#d1d1d1","color":"#000"},  //缩略图样式
		thumSelected : {"background":"#ba2451","color":"#fff"},  //缩略图选中样式
