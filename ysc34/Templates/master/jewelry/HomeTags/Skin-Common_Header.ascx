...
<body>
    ...
    <div id="header" class="top">
        ...
        <div class="header-2014 o-hidden">
           <div class="w1200 m0 pt20 pb20 o-hidden both">
            <div class="logo fl ">
                <Hi:Common_Logo ID="Common_Logo1" runat="server" />
            </div>
             <div class="fr">
                <Hi:Common_ImageAd runat="server" AdId="35" />
            </div>
            <div class="fr search_box o-hidden ">
               <Hi:Common_Search ID="Common_Search" runat="server" />        
            </div>           
         </div>
        </div>
        <div class="nav both">
            <div class="nav1 w1200 m0" >
               <div class="all fl posr">
                  <h3 class="title">全部商品分类</h3>
                  <div class="my_left_category fl">
                      <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="13" runat="server" />
                  </div>
               </div>
               <div class="nav2 fl yahei font14" id="ty_menu_title"  >
                   <ul>
               ...
               <div class="buycart fr o-hidden"><Hi:Common_ShoppingCart_Info ID="Common_ShoppingCart_Info1" runat="server" /></div>
            </div>
        </div>        
    </div>
