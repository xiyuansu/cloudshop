        ...
        <div class="site-nav">
            <div class="site-nav-bd">
                <ul class="site-nav-bd-l">
                    <li class="menu"><Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" /></li>
                </ul> 
                <div style="display:none;">
                    <Hi:Common_SetDeliveryRegion ID="setDeliverRegion" OnlyShowInDefault="true" runat="server">
                </Hi:Common_SetDeliveryRegion></div>
                <ul class="site-nav-bd-r">         
                    <li class="menu"><Hi:Common_LoginLink runat="server" /></li>         
                    <li class="menu"><Hi:Common_MyAccountLink runat="server" /></li>
                    <li class="menu"><a href="/user/UserOrders">我的订单</a></li>
                    <li class="menu"><a href="/Helps">客户服务</a></li>
                    <li class="menu"><a href="/Articles">商城资讯</a></li>
                    <li class="menu">
        ...
        <div class="site-head">
            <div class="site-head-bd">
                <div class="site-head-bd-l">
                    <div class="logo">
                        <h1><Hi:Common_Logo runat="server" /></h1>
                    </div>
                </div>
                ...
                <div class="site-head-bd-r">              
                    <div class="float-l mt15"><Hi:Common_ImageAd AdId="17" runat="server" /></div>
                </div>
            </div>
        </div>
            ...
            <div class="main-nav-bd">
                <div class="main-nav-bd-l all">
                    ...
                    <div class="my_left_category">
                        <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="8" runat="server" />
                    </div>
                </div>
