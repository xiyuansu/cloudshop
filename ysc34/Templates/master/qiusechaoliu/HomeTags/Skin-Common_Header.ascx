    ...
    <div id="header">
        <div class="top-nav">
            <div class="w1200 m0"> 
                    ...
                    <div class="top-left fr"> 
                        <span> <Hi:Common_ShoppingCart_Info ID="Common_ShoppingCart_Info1" runat="server" /></span> 
        ...
        <div class="nav ">
                <div class="nav-l w1200 both m0 font-yh" >
                      <div class="all fl">
                          <h2 class="align-tenter"><b> 全部商品分类 </b></h2>
                          <div class="my_left_category fl" >
                              <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="13" runat="server"  SkinName="HomeTags/Skin-CategoriesWithWindow1.ascx"/>
                          </div>
                      </div>
