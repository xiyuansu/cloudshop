        ...
        <div class="cat-01" id='<%# "twoCategory_" + Eval("CategoryId")%>'>
            <dl class="menu01">
                <dt>
                    ...
                    </span><a href='<%# Globals.GetSiteUrls().SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a>
                </dt>
                <dd>
                ...
                <div class="T-menu01">
                    <div class="L-menu">
                        <asp:Repeater runat="server" ID="recordstwo">
                            <ItemTemplate>
                                ...
                                <div>
                                    <h4><i>></i><div style="width:130px;"><a href='<%# Globals.GetSiteUrls().SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a></div></h4>
                                    <span>
                    ...
                    <span class="brand">
                        ...
                        <asp:Repeater runat="server" ID="recordsbrands">
                            <ItemTemplate>
                                <a href='<%# Globals.GetSiteUrls().UrlData.FormatUrl("branddetails",Eval("BrandId"))%>'> <img src='<%#Eval("Logo") %>' />
                               </a>
                            </ItemTemplate>
                        </asp:Repeater>
                    </span>
