...
<body>
    ...
    <div id="header" class="header">
        <a name="huitop"></a>
        <div class="w1200 m0 yahei ">           
            <div class="logo fl o-hidden">
                <Hi:Common_Logo ID="Common_Logo1" runat="server" />
            </div>
            <div class="navitems-2014 fr font14" id="ty_menu_title">
                <ul>
                    ...
                    <li id="member_Frame" style="display:none">
                        <em onmouseover="Showmember_tab();" onmouseout="Hiddenmember_tab();">会员中心</em>
                        <div id="member" onmouseover="Showmember_tab();" onmouseout="Hiddenmember_tab();">
