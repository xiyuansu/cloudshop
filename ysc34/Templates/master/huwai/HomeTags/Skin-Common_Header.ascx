    ...
    <div id="header" class="top">
        <div class="header">
            <div class="h_top">
                <div class="w1200">
                    <div class="fl">
                        <span class="welcome"><Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" /></span>
                        <span class="fontred"><Hi:Common_LoginLink ID="Common_Link_Login1" runat="server" /></span>
                        <span class="fontred"><Hi:Common_MyAccountLink ID="linkMyAccount" runat="server" /></span>
                    </div>
                    <div class="fr">
                        <span class="buycart">
            ...
            <div class="h_mid">
                <div class="w1200">
                    ...
                    <div class="search_box"><Hi:Common_Search ID="Common_Search" runat="server" /></div>
                </div>
            </div>
        </div>
    </div>
