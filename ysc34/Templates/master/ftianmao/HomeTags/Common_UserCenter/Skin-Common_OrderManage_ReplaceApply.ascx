...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_box1">
    <tr id="spqingdan_title">
        ...
        <td width="30%" align="center">换货商品</td>
        <td width="20%" align="center">申请时间</td>
    ...
    <asp:Repeater ID="listReplace" runat="server">
        <ItemTemplate>
            <tr class="ddgl_1">
                ...
                <td align="center">
                    <Hi:ReplaceStatusLabel ID="lblHandleStatus" Status='<%# Eval("HandleStatus") %>' runat="server" /><br />
                ...
                <td align="center" nowrap="nowrap">
                    <asp:HyperLink ID="hlinkOrderDetails" runat="server" Target="_blank" NavigateUrl='<%# Globals.GetSiteUrls().UrlData.FormatUrl("user_UserReplaceApplyDetails",Eval("ReplaceId"))%>' Text="查看" />
