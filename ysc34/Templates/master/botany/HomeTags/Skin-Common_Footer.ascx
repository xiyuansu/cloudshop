...
<div class="footer" id="footer">
  ...
  <div class="container footer-help">
    <ul class="o-hidden"><hi:common_help runat="server" templatefile="/hometags/Common_Comment/Skin-Common_Help.ascx" /></ul>   
    <div class="footer-phone"><Hi:Common_CustomAd runat="server" AdId="28" /></div> 
    <div class="footer-weixin"><Hi:Common_CustomAd runat="server" AdId="16" /></div>
  </div>
