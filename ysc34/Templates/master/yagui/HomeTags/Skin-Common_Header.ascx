    ...
    <div id="header">
        ...
        <div class="headertop">
            <div class="headertopc">
                <div class="headertopcl">
                    <Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" /><em>[ 
                        <Hi:Common_MyAccountLink ID="linkMyAccount" runat="server" />]</em><em>[
                ...
                <div class="headertopcr">
                    <A href="/ShoppingCart.aspx">购物车</a> |<a href='/user/UserOrders.aspx'>我的订单</a>|<a href='/Helps.aspx'>帮助中心</a>
                </div>
            </div>
        </div>

        <div class="headers">
            <div class="headerslogo">
                <Hi:Common_Logo ID="Common_Logo1" runat="server" />
            </div>
            <div class="headerssearcher">
                <div class="headerssearcher1">
                    <Hi:Common_Search ID="Common_Search" runat="server" />
                </div>
                <div class="headerssearcher2">
                    <b>热搜：</b>
