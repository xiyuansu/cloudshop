...
<div class="footer" id="footer">
    <div class="w1200 o-hidden"><Hi:Common_ImageAd runat="server" AdId="19" /></div> 
    <div class="footer-help w1200 o-hidden">
          ...
          <div class="footer_r"><Hi:Common_CustomAd runat="server" AdId="32" /></div>
    </div>
    <div class="footer-custom pt20">
    	<div class="w1200 o-hidden">
