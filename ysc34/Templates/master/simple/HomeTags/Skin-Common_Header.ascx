	...
	<div class="h_top w1200 m0">
        ...
        <div class="top_nav">
        	<div class="top_link">
                ...
                <em>|</em> 
                <span class="phone"><hi:common_customad runat="server" adid="2"></hi:common_customad></span>
                <em>|</em> 
                <span><hi:common_customad runat="server" adid="3"></hi:common_customad></span>
            ...
            <div class="top_adv"><hi:common_customad runat="server" adid="4"></hi:common_customad></div>
        </div>
    </div>
    <div class="nav_box">
    	<div class="nav w1200 m0">
        	<ul>
                <li class="select"><a href="/"><span>首页</span></a></li>
                <Hi:Common_PrimaryClass ID="Common_PrimaryClass1" runat="server" />
                <Hi:Common_HeaderMune ID="Common_HeaderMune1" runat="server" />
            </ul>
            <div class="buycart"><Hi:Common_ShoppingCart_Info ID="Common_ShoppingCart_Info1" runat="server" /></div>
        </div>
    </div>
</div>
