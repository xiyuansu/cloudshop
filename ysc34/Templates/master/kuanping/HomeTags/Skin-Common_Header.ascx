...
<body>
  ...
  <div class="top-nav">
            <div class="w1200">
                   ...
                   <span style="display:none;"> <Hi:Common_SetDeliveryRegion ID="setDeliverRegion" OnlyShowInDefault="true" runat="server"></Hi:Common_SetDeliveryRegion></span>
        ...
        <div class="nav w1200 c-both">
                <div class="nav-l" >
                      <div class="all float-l">                         
                          ...
                          <div class="my_left_category float-l"><Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="12" runat="server" /></div>
                      </div>
