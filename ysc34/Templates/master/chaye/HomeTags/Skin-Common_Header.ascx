                ...
                <div class="top-right">
                    ...
                    <div class="float-r">
                        <ul>
                            ...
                            <li>|</li>
                            <li>
                                <Hi:Common_CustomAd runat="server" AdId="1" isdelayedloading="true" />
                            </li>
                            <li>|</li>
                            <li>
...
<li>
    ...
    <script>
        ...
        $(".all").hover(function () {
            $(".my_left_category").slideDown(1000).css({ 'display': 'block' });
        }, function () {
