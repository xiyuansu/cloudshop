...
<body>
    ...
    <div id="header">
        ...
        <div class="nav w1200 c-both">
                ...
                </div><div class="denglus">   <span class="zhuche"> <Hi:Common_LoginLink ID="Common_Link_Login1"  runat="server" /></span>  <span class="denglu"> <Hi:Common_MyAccountLink ID="linkMyAccount" runat="server"  /></span> </div>
        </div>
        </div>
    </div>
