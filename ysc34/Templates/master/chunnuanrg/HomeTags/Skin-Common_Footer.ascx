...
<div id="footer" class="footer">
 <div class="helpbg"><div class="helpdiv"><div class="help"><ul>
 <Hi:Common_Help runat="server" TemplateFile="/hometags/Common_Comment/Skin-Common_Help.ascx" />
 
 </ul></div>
 <div class="ad"> <Hi:Common_ImageAd runat="server" AdId="12" /></div>
 
 </div></div> 
<div class="textadbg"><div class="textad"> <Hi:Common_FriendLinks runat="server" TemplateFile="/hometags/Common_Comment/Skin-Common_FriendLinks.ascx" /></div></div>
<div class="copyrightbg"><div class="copyright">        <div>
