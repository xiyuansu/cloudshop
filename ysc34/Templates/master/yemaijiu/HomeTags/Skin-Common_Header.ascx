...
<body>
    ...
    <div id="full" style='right: 20px; position: absolute; top: 200px; z-index: 100'>
        <a href="javascript:void(0);"
            onclick='window.scrollTo(0,0);'></a>
    </div>
    ...
    <div id="header">
        ...
        <div class="web_topb1">
            <div class="web_topb2_1">
                <div class="logininfo">
                    <span class="login_zhuangtai">
                        <Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" />
                        <b>
                            <Hi:Common_MyAccountLink ID="linkMyAccount" runat="server" /></b> |
                        <b>
                            <Hi:Common_LoginLink ID="Common_Link_Login1" runat="server" /></b>
                ...
                <ul class="toplink" id="navtoplink">
                    ...
                    <li>
                        <a href='/user/UserOrders.aspx'>我的订单</a></li>
                    <li>|</li>
                    <li>
                      <a href='/Helps.aspx'>帮助中心</a></li>
                    <li>|</li>
<li>
                                <Hi:Common_AppDownloadQRCode ID="Common_AppDownloadQRCode1" runat="server" /></li>

                    <li><a href="url:LeaveComments"><b>关注我们：</b></a></li>
            ...
            <div class="nav_big1">
                <div class="qbfl">
                    <div class="all float-l">
                        <h2>
                           <img src="/templates/master/yemaijiu/images/ymj_10.jpg" /> </h2>
                        <div class="my_left_category float-l">
                            <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="20" runat="server" SkinName="HomeTags/Skin-CategoriesWithWindow1.ascx"/>
                        </div>
                    </div>
                </div>
                <div class="nav_r" id="ty_menu_title">
                    <ul class="nav_bigmbg">
