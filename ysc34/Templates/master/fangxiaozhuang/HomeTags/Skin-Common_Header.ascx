...
<body>
    ...
    <div id="header" class="top">
        <div class="top_ad1"><Hi:Common_CustomAd runat="server" AdId="32" /></div>
        <div class="top_nav_fxz">
            <div class="w1200">
                    <div class="top-right">                   
                    
                    <div class="fr top1_r float-l">
                        <ul>
                        <li> <Hi:Common_CurrentUser runat="server" ID="lblCurrentUser" /></li>
                            <li>
        ...
        <div class="top-search clearfix">
            ...
            <div class="float-r ad20"><Hi:Common_CustomAd runat="server" AdId="33" /></div>
        </div>
