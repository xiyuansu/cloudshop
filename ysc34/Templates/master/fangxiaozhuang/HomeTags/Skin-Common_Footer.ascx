...
<div class="footer" id="footer">
    <div class="footer_f1"><div class="footer_ad7"> <hi:common_imagead runat="server" adid="21"></hi:common_imagead></div></div>
    ...
    <div class="fm_footer">
        <div class="footer_1">
            <div class="footer-help  o-hidden" style=" height:220px; overflow:hidden;">
                ...
                <span class="footer_ad1"><Hi:Common_CustomAd runat="server" AdId="41" /> </span>   
                <span class="footer_ad2"><Hi:Common_ImageAd runat="server" AdId="42"/></span>  
            </div>
