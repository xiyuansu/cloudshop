...
<li>
    ...
    <div class="ueser-txt">
        <span><i style="width:30px;height:30px;display: block;float:left;padding-right:5px;"></i><%# string.IsNullOrEmpty(Eval("UserName").ToString())?"":(Eval("UserName").ToString().Substring(0,1)+"***"+Eval("UserName").ToString().Substring(Eval("UserName").ToString().Length-1,1)) %></span>
