    ...
    <ItemTemplate>
        ...
        <div class="my_left_cat_list">
            <div id='<%# "twoCategory_" + Eval("CategoryId")%>' class="h2_cat">
                ...
                </em><a href='<%# RouteConfig.SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a> </h3>
                                ...
                                <asp:Repeater runat="server" ID="recordstwo">
                                    <ItemTemplate>
                                        ...
                                        <div class="fenlei_jianduan">
                                            <h4>
                                                <div style="width: 130px;"><a href='<%# RouteConfig.SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a></div>
                                            </h4>
                                            <div class="fthree">
