...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_box1">
    <tr id="spqingdan_title">
        ...
        <td width="25%" align="center">退货商品</td>
    ...
    <asp:Repeater ID="listReturns" runat="server">
        <ItemTemplate>
            <tr class="ddgl_1">
                ...
                <td align="center">
                    <Hi:ReturnStatusLable ID="lblHandleStatus" Status='<%# Eval("HandleStatus") %>' runat="server" />
                ...
                <td align="center" nowrap="nowrap">
                    <asp:HyperLink ID="hlinkOrderDetails" runat="server" Target="_blank" NavigateUrl='<%# Globals.GetSiteUrls().UrlData.FormatUrl("user_UserReturnsApplyDetails",Eval("ReturnsId"))%>'
                        Text="查看" />
