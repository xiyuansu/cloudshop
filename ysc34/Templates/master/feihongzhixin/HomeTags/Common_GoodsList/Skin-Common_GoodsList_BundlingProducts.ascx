...
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.SaleSystem.Tags" Assembly="Hidistro.UI.SaleSystem.Tags" %>
 <div class="bundlitem clearboth">
     ...
     <div class="bunditem_l">
            ...
            <ul class="clearboth">    
                  <li><asp:HyperLink ID="hlBuy" runat="server" CssClass="Product_btn_gm" bundingId='<%# Eval("BundlingID") %>' NavigateUrl='<%# "~/SubmmitOrder.aspx?buyAmount=1&Bundlingid="+Eval("BundlingID")+"&from=Bundling"%>'>立即购买</asp:HyperLink>
                  ...
                  <asp:Label Visible="false" runat="server" ID="lbBundlingID" Text='<%# Eval("BundlingID") %>' />
                   ...
                   <li><em>节省：</em><strong style="color:#0091ea">￥<Hi:FormatedMoneyLabel  runat="server" ID="lblsaving" /></strong></li>
