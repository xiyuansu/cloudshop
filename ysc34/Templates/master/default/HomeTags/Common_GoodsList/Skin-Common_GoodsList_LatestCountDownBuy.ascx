...
<asp:Repeater ID="repcountdown" runat="server">
    <ItemTemplate>
        ...
        <Hi:ListImage ID="HiImage1" runat="server" DataField="ThumbnailUrl220" IsDelayedLoading="true" /></Hi:ProductDetailsLink></span>
            <div class="pro-name">
            ...
            <div class="pro-price"><span><i class="rmb">¥</i><Hi:FormatedMoneyLabel runat="server" ID="lblPrice" Money='<%# Eval("CountDownPrice") %>' /></span><i>¥<Hi:FormatedMoneyLabel runat="server" ID="lblMarketPrice" Money='<%#Eval("MarketPrice").ToDecimal()>0?Eval("MarketPrice"):Eval("SalePrice") %>' /></i></div>
