...
<div class="footer  o-hidden pt20" id="footer">
    <div><Hi:Common_CustomAd runat="server" AdId="16" /></div>

<div class="helpbg">    <div class="footer-help w1200 o-hidden">
          <ul class="o-hidden">
              <Hi:Common_Help runat="server" TemplateFile="HomeTags/Common_Comment/Skin-Common_Help.ascx" />
          </ul>   
        <div><Hi:Common_CustomAd runat="server" AdId="17" /></div>    
    </div>
     </div>
    <Hi:Common_CustomAd runat="server" AdId="46" />  
    <div class="w1200 footer-custom pt20">
