    ...
    <div id="header">
        <div class="headetop">
            <div class="headetopc">
                ...
                <div style="float: right;" class="top1_r">
                    <ul>
                        <li>
                        ...
                        <li><a href='<%#GetRouteUrl("LeaveComments") %>'>联系我们</a></li>
        ...
        <div class="headlogo">
            <div class="headlogoc">
                ...
                <div class="heaeright">
                    <div>
                        <Hi:Common_CustomAd runat="server" AdId="32" />
                    </div>
                    <div class="search">
        ...
        <div class="heademeun">
            <div class="nav w1200 c-both">
                <div class="nav-l">
                    <div class="side_nav float-l">
                        <h3 class="title">
                            全部商品分类
                        </h3>
                        <div class="my_left_category1">
                            <div class="my_left_category">
                                <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="12" runat="server" SkinName="/hometags/Skin-CategoriesWithWindow.ascx" />
                            </div>
                        </div>
                    </div>
