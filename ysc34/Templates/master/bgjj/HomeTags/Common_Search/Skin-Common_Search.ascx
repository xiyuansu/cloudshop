...
<div class="search1" style="position:relative;">
<input type="text" id="txt_Search_Keywords" class="search" placeholder="" />
<input type="button" value="" onclick="searchs()" class="btn1" style="position: absolute;width:30px;height:25px; right: 0; top: 0; background: none;" />
</div>
<div class="hot-key">
