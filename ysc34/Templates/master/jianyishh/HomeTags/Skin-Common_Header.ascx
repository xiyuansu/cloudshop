    ...
    <div id="header" class="top" >
        ...
        <div class="top_nav_bg">
            <div class="top1_nav">        
                ...
                <div class="link_list">                
                     <span><a href="user/UserOrders.aspx">订单查询</a></span>
                     <span><span>|</span><a href="ProductUnSales.aspx">下架区</a></span>
                     <span>|</span>
                     <span><a href="#">商城交流区</a></span>                    
                     <span>|</span>
                     <span><a href="Helps.aspx">帮助中心</a></span>
                     <span>|</span>
                     <span><a href="OnlineGifts.aspx">积分商城</a></span>
                    <span class="fore3"><Hi:Common_VshopQRCode ID="Common_VshopQRCode1" runat="server" /></span>            
                </div>            
            </div>    
        </div>
        
        <div class="header1_p"><Hi:Common_ImageAd runat="server" AdId="2"  isdelayedloading="true"/></div>
        ...
        <div class="nav_bg">
            <div class="nav1">               
                ...
                <div class="nav_c_r"><Hi:Common_CustomAd runat="server" AdId="17" /></div>
            </div>
        </div>         
    </div>
