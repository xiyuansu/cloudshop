                            ...
                            <span class="category" > 
                               <asp:Repeater runat="server" ID="recordstwo">
                                    <ItemTemplate>
                                         ...
                                         <div class="fenlei_jianduan"> <h4><i>></i><div style="width:130px;"><a href='<%# RouteConfig.SubCategory(Convert.ToInt32(Eval("CategoryId")), Eval("RewriteName")) %>'><%# Eval("Name")%></a></div></h4>
                                            <div class="fthree">
