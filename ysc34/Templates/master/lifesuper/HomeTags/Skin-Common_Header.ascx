...
<body>
    ...
    <div id="header" class="top">
        <div class="top-nav">
            <div class="w1200 m0">
                    <div class="tl fl">
                      ...
                      <div class="tr fr">
                        <span>
                            <a href="user/UserDefault.aspx">我的帐户</a>
                        </span>
                        <span>|</span>
                        <span>
                            <a href="user/UserOrders.aspx">订单查询</a>
                        </span> 
                        <span>|</span>
                        <span>
        ...
        <div class="header-2014">
           <div class="w w1200 pt20 pb20 o-hidden m0 both">
            <div class="logo fl">
                <Hi:Common_Logo ID="Common_Logo1" runat="server" />
            </div>
            <div class="fr posr pt20">
                <div class="cart-box mr10">
                    <a href="/ShoppingCart.aspx">
                        <Hi:Common_ShoppingCart_Info ID="Common_ShoppingCart_Info1" runat="server" />
                    </a>
                </div>
                <div class="search-box fr pr10 o-hidden">
                   <Hi:Common_Search ID="Common_Search" runat="server" />
                </div>
            </div>
           </div> 
           
           <div class="nav w1200 m0 both yahei" >
                      <div class="categorys-2014 fl posr all"  >
                          <h2 class="font18 bold pl10">全部商品分类</h2>
                          <div class="my_left_category">
                                <Hi:Common_CategoriesWithWindow ID="Common_CategoriesWithWindow1" MaxCNum="12" runat="server" />
                          </div>
                      </div>
                      <div class="navitems-2014 fl" id="ty_menu_title">
                           <ul>
                      ...
                      <div class="fr"><Hi:Common_ImageAd runat="server" AdId="1" /></div> 
                </div>
