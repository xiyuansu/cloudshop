...
<body>
    ...
    <div class="sid_qq">
      <div class="qq_man"></div>
      <div class="qq_con1">
      <hi:common_customad runat="server" adid="37"></hi:common_customad>
      </div>
      
      <div class="go_top"><a href="#" onclick="goTop();">TOP</a></div>
      
      </div>
  
    <div class="top_ad1"><Hi:Common_CustomAd runat="server" AdId="1" /></div>
        <div class="top-nav">
            <div class="w1200">
                    <div class="top-right">
                    <div class="float-l">
                      ...
                      <div class="float-r">  <span id="xinren_Frame">
    ...
    <script type="text/javascript">
        ...
        <div class="w1200 pb10 o-hidden c-both">
            ...
            <div class="float-l">
                ...
                <div class="hot-key">
                    <em>热门关键字：</em>
                  <div>  <Hi:Common_SubjectKeyword ID="Common_SubjectKeyword1" runat="server" CommentId="1" /></div>
                </div>
            </div>
            <div class="float-l ad20">
              <Hi:Common_CustomAd runat="server" AdId="20" />
            </div>
        ...
        <div class="nav_bl"></div>
        <div class="nav_br"></div>
