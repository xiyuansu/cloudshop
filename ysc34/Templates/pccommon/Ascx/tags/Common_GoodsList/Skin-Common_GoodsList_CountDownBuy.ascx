    ...
    <div class="buy_product">
        ...
        <div class="buy_info">
            ...
            <div class="buy_price">
                ...
                <del>￥<Hi:FormatedMoneyLabel runat="server" ID="lblOldPrice" Money='<%# Eval("MarketPrice").ToInt()>0?Eval("MarketPrice"):Eval("SalePrice")  %>' /></del>
            ...
            <div class="buy_andere">
                ...
                <em style="display: none;">限购数量：<span><asp:Label runat="server" ID="lblCount" Text='<%# Eval("MaxCount") %>' /></span></em>
            </div>
        </div>
    </div>
</li>
<div style="display: none;">
    结束时间：<Hi:FormatedTimeLabel runat="server" ID="lblEndTime" Time='<%# Eval("EndDate") %>' />
</div>
