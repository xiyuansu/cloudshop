...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_box1">
    <tr id="spqingdan_title">
        <td width="20%" align="left" style="padding-left:10px;">售后编号</td>
        <td width="20%" align="left">订单编号</td>
        <td width="15%" align="left">申请时间</td>
        <td width="10%" align="left">退款金额</td>
        <td width="12%" align="left">
            <div class="txt1" id="StatusList">
                <em>订单状态</em>
                <div class="txt2">
                    <span status="0">申请退款</span>
                    <span status="1">退款成功</span>
    ...
    <asp:Repeater ID="listRefundOrder" runat="server">
        <ItemTemplate>
            <tr class="ddgl_1">
                 <td align="left" style="padding-left:10px;"><em><%# Eval("RefundId") %></em></td>
                <td align="left"><%# Eval("OrderId") %></td>
                <td align="left"><%# Eval("ApplyForTime")%></td>
                <td align="left"><%# Eval("RefundAmount","{0:F2}")%></td>
                ...
                <td align="left" nowrap="nowrap">
                    <asp:HyperLink ID="hlinkOrderDetails" runat="server" Target="_blank" NavigateUrl='<%# GetRouteUrl("user_UserRefundApplyDetails", new {RefundId =Eval("RefundId")})%>' Text="查看" />
