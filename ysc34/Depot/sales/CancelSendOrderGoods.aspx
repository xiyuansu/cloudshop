<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true" CodeBehind="CancelSendOrderGoods.aspx.cs" Inherits="Hidistro.UI.Web.Depot.CancelSendOrderGoods" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function (e) {
            ...
            $("#cancelsendgoods").click(function (e) {
                ...
                if (isCancel) {
                    var orderId = $("#ctl00_contentHolder_lblOrderId").html();
                    var url = '/Depot/Sales/ashx/ManageOrder.ashx?action=CancelSendGoods';
                    var expressData;
                    $.ajax({
                        type: "post",
                        url: url,
