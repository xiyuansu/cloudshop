<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true"
    CodeBehind="BatchPrintData.aspx.cs" Inherits="Hidistro.UI.Web.Depot.sales.BatchPrintData" %>
...
<%--        <div class="title  m_none td_bottom" style="padding: 5px 0px 5px 12px">
        ...
        <div class="title">
            <ul class="title-nav">
                <li><a href="javascript:void" class="hover">发货人信息</a></li>
            </ul>
        </div>
        <div>
            ...
            <asp:Panel runat="server" ID="pnlShipper">
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="PrintDataTable">                    
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Literal ID="ltlShipTo" runat="server"></asp:Literal>                           
                        </td>
                    </tr>
                    <tr>
                        <th>
        ...
        <div class="title  m_none td_bottom" style="padding: 5px 0px 5px 12px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="80%">
                        <span style="color: Red">注意：打印时请选择默认打印机，并且在IE8以上浏览器打印效果比较理想</span></td>
                </tr>
            </table>
        </div>
        <div class="datafrom" style="padding-bottom: 1px;">
            <asp:Panel runat="server" ID="pnlTemplates">
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="PrintDataTable">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList runat="server" CssClass="forminput form-control" ID="ddlTemplates">
                            </asp:DropDownList>
                        </td>
                        <td>快递单起始编号:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtStartCode" CssClass="forminput form-control" />
                        </td>
                        <td>
