<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true" EnableViewState="false" CodeBehind="ReturnsApply.aspx.cs" Inherits="Hidistro.UI.Web.Depot.sales.ReturnsApply" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li><a href="javascript:void(0);" class="statusanchors hover" data-status="">全部退货申请单</a></li>
                <li>
    ...
    <script id="datatmpl" type="text/html">
        {{each rows as item index}}
                <tr>
                    <td>
                        <input name="CheckBoxGroup" type="checkbox" value='{{item.ReturnId}}' class="icheck" /></td>
                    ...
                    <td nowrap="nowrap">{{item.ReturnStatusStr}}</td>
                    <td>&nbsp;{{item.handleTimeStr}}</td>
                    <td>
                        <span><a href="ReturnApplyDetail?ReturnId={{item.ReturnId}}">{{item.OperText}}</a></span>
                    </td>
                </tr>
        {{/each}}
    </script>
    ...
    <input type="hidden" name="dataurl" id="dataurl" value="/Depot/sales/ashx/ReturnsApply.ashx" />
    <script src="/Utility/artTemplate.js" type="text/javascript"></script>
    <script src="/Utility/artTemplate.Helper.Common.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.HiPaginator.js" type="text/javascript"></script>
    <script src="/Utility/Hidistro.List.Common.js" type="text/javascript"></script>
    <script src="/Depot/sales/scripts/ReturnsApply.js" type="text/javascript"></script>
</asp:Content>
