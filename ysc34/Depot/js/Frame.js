    ...
    $.ajax({
        ...
        success: function (xml) {
            ...
            $(xml).find("Module[Title='" + firstnode.replace(/\s/g, "") + "'] Item").each(function (i) {
                ...
                $menuaspan = $("<span onclick='ShowSecond(this)'><i class='i-o' style='display:block'>∧</i><i class='i-t' style='display:none'>∨</i>" + $(this).attr("Title") + "</span>"); //获取二级分类名称
...
$(document).ready(function(){       
            $('.hishop_menutitle span').live('click',function() {               
                 $(this).children(".i-o").toggle();
                $(this).children(".i-t").toggle();                              
            });    
    });