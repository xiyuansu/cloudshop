<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true" CodeBehind="MdyMarketingImageProduct.aspx.cs" Inherits="Hidistro.UI.Web.Depot.home.MdyMarketingImageProduct" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            <ul class="title-nav">
                <li><a href="MarketingImageManage.aspx">营销图片管理</a></li>
                <li><a class="hover">配置商品</a></li>
            </ul>
        </div>
        ...
        <div class="datafrom">
            <div class="formitem validator1 depot-p">
                <ul>
                    <li class="clearfix"><span class="formitemtitle">营销图片名称：</span>
                        <input type="text" id="txtImageName" class="forminput form-control" style="width: 160px" runat="server" />
                    </li>
                    <li class="clearfix"><span class="formitemtitle">营销图片描述：</span>
                        <input type="text" id="txtDescription" class="forminput form-control" style="width: 160px" runat="server" />
                    </li>
    ...
    <script src="/Depot/home/scripts/MdyMarketingImageProduct.js?v=3.1" type="text/javascript"></script>
</asp:Content>
