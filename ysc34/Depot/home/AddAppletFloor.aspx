<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true" CodeBehind="AddAppletFloor.aspx.cs" Inherits="Hidistro.UI.Web.Depot.home.AddAppletFloor" %>
        ...
        <div class="datafrom">
            <div class="formitem validator1 depot-p">
                ...
                <ul class="btntf Pa_198 clear">
                    <li>
                        <input type="button" value="保 存" class="btn btn-primary inbnt" id="btnAdd" onclick="doAddSubmit();" /></li>
                </ul>
            </div>
        </div>
    </div>
