...
function ShowListData(target, page, pagesize, initpagination) {
    var TimeScope = $("#selTimeScope").val();
    page = page || 1;
    pagesize = pagesize || 10;
    if (typeof (initpagination) == "undefined") { initpagination = true; }
    var urldata = {
        PageIndex: page, PageSize: pagesize, GroupId: "2", TimeScope: TimeScope, flag: "GetStoreUsersStatistics"
    }
