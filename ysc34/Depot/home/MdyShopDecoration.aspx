<%@ Page Title="" Language="C#" MasterPageFile="~/Depot/Admin.Master" AutoEventWireup="true" CodeBehind="MdyShopDecoration.aspx.cs" Inherits="Hidistro.UI.Web.Depot.home.MdyShopDecoration" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
            ...
            <div class="formitem validator1 depot-p">
                <ul>
                    <li class="clearfix"><span class="formitemtitle"><em>*</em>楼层名称：</span>
                        <input type="text" id="txtFloorName" class="forminput form-control" style="width: 160px" maxlength="10" runat="server"/>
                    ...
                    <li><span class="formitemtitle">关联营销图片：</span>
                        ...
                        <span>已选择营销图片:</span>&nbsp;<span id="spGLYXTP" style="color:Red;" runat="server"></span><span id="spGLYXTPID" style="display:none" runat="server"></span>
                    </li>
                     <li><span class="formitemtitle">楼层排序：</span>
                      <input type="text" id="txtDisplaySequence" class="forminput form-control" style="width: 160px" maxlength="10" runat="server"/>
    ...
    <script src="/Depot/home/scripts/MdyShopDecoration.js?v=3.1" type="text/javascript"></script>
</asp:Content>
