<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Hidistro.UI.Web.AliOH.Default" %>
...
<head>
    ...
    <script type="text/javascript">
     ...
     .members_nav1 li.board6{ width: 50%; border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;}
         .members_nav1 li.big1_img{ width: 50%;border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;}
        .members_nav1 ul li.big_img {
            width:40%;
        ...
        .members_nav1 ul li.mid_img {
            width:60%;
            border-top: 1px solid #e7e5ea;
        }

        .members_nav1 ul li.mid1_img {
            width:39.9%;
            border-top: 1px solid #e7e5ea;
            border-right: 1px solid #e7e5ea;
        }

        .members_nav1 ul li.small_img {
            width:30%;
            border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;
        }

        .members_nav1 ul li.small1_img {
            width:30%;
            border-right: 1px solid #e7e5ea;
            border-top: 1px solid #e7e5ea;
        }

        .members_nav1 li.small2_img {
            width:25%;
...
<body onload="restartPosition()">
    ...
    <div id="noTip3">
     ...
     <div class="dingwei" id="divReferralInfo" runat="server" visible="false">
        ...
        <div class="plr11 ptb13 storeinfo" id="stores">
            <div class="pic">
                <img class="logo" src="/Storage/master/depot/201706201002486513670.png" runat="server" id="Referral_Logo"></div>
            <div class="intro">
                <div class="info storename">
                    <h3><asp:Literal ID="Referral_ShopName" runat="server"></asp:Literal></h3>
                </div>
    ...
    <div class="membersbox pad50" style="margin: 0 auto;">
        ...
        <Hi:HomePage runat="server" ID="H_Page" ClientType="AliOH"></Hi:HomePage>
    ...
    <link rel="stylesheet" href="/templates/common/style/index.css?v=3.0" type="text/css" />
