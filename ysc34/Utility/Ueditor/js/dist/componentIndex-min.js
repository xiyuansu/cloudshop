...
HiShop.Constant = HiShop.Constant ? HiShop.Constant : {},
    ...
    HiShop.hint = function (a, b, c) {
        if (a && b) {            
            var tempd = $("#tpl_hint").html() != undefined ? $("#tpl_hint").html() : "";
            var d = tempd,
                e = _.template(d, {
                    type: a,
                    content: b
        ...
        Win = {
                ...
                a.ajax({
                    ...
                    success: function (d) {
                        if (1 == d.status) {
                            ...
                            var i = a(_.template(a("#tpl_albums_imgs").html(), {
                                dataset: Cache.imgs
                            })),
                                j = a(d.page);
            ...
            a.albums = function (c) {
                ...
                var f = a("#albums"),
                    g = a("#albums-overlay");
                if (!f.length) {
                    f = a(a("#tpl_albums_main").html()),
                        g = a(a("#tpl_albums_overlay").html()),
                    ...
                    a.ajax({
                        ...
                        type: "post",
                        dataType: "json",
                        data: { supplierId: UE.supplierId },
                        success: function (b) {
                            if (1 == b.status) {
                                var c = _.template(a("#tpl_albums_tree_fn").html()),
                                    d = c({
                                        dataset: b.data.tree,
                                        templateFn: c
                                    }),

                                        e = a(_.template(a("#tpl_albums_tree").html(), {
                                            dataset: b.data,
                                            nodes: d
                                        }));
                                p.empty().append(e),
                        ...
                        i.click(function () {
                            ...
                            a.ajax({
                                ...
                                success: function (c) {
                                    if (1 == c.status) {
                                        b[0].id = c.data;
                                        var d = _.template(a("#tpl_albums_tree_fn").html(), {
                                            dataset: b
                                        });
                                        $render = a(d),
                ...
                f.fadeIn("fast"),
                    ...
                    f.on("change", ".iselect_one",
                        function (item) {
                            var sort = this.value;
                            GetImgList(f, Cache.folderID, 1, "", sort);
