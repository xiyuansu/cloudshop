        ...
        render: function (opts, container) {
            ...
            for (var i = 0; i < opts.imagesCount; i++) {
                ...
                html += ' <div class="upload-img-box" imageBox ' + display + '>\
                                ...
                                <input class="file uploadFilebtn" style="cursor: pointer;position:absolute;left:0;top:0;width:100%;height:100%;z-index:1;opacity:0;" type="file"  name="_file"   id="imgUploader_' + id + '_' + i + '"/>\
