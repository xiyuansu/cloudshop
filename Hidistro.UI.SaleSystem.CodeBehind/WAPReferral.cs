	...
	public class WAPReferral : WAPMemberTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
			...
			if (user != null)
			{
				...
				this.rptAccountSummary = (WapTemplatedRepeater)this.FindControl("rptAccountSummary");
				...
				this.litDrawSplittin.Text = MemberProcessor.GetUserDrawSplittin().ToNullString();
