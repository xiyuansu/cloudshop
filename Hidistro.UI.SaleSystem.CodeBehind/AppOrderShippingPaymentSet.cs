...
{
	[ParseChildren(true)]
	public class AppOrderShippingPaymentSet : AppshopMemberTemplatedWebControl
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			{
				this.shoppingCart = ShoppingCartProcessor.GetShoppingCart(this.from, this.productSku, this.buyAmount, 0, true, -1, 0);
			}
