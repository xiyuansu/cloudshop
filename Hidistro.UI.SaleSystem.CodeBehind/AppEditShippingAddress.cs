...
{
	[ParseChildren(true)]
	public class AppEditShippingAddress : AppshopMemberTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
			...
			if (masterSettings.OpenMultStore)
			{
				...
				if (this.WAPLocateAddressUpgrade != null)
				{
					...
					this.WAPLocateAddressUpgrade.Address = shippingAddress.Address;
					this.WAPLocateAddressUpgrade.RegionLocation = shippingAddress.RegionLocation;
