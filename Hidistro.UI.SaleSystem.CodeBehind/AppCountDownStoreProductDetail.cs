...
{
	public class AppCountDownStoreProductDetail : AppshopTemplatedWebControl
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			{
				this.SkinName = "Skin-VCountDownProductStoreDetail.html";
			}
			base.OnInit(e);
		}
		...
		private void SetControlsValue(CountDownInfo countDownInfo)
		{
			...
			{
				this.ShowWapMessage("抢购商品已不存在", "goHomeUrl");
			}
			else
			{
				...
				{
					this.ShowWapMessage("此商品已下架", "goHomeUrl");
				}
				...
				this.litShortDescription.SetWhenIsNotNull(storeProduct.ShortDescription);
				...
				this.salePrice.Text = storeProduct.MinSalePrice.F2ToString("f2");
