...
{
	[ParseChildren(true)]
	public class WapShopInfo : WAPMemberTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				if (user == null)
				{
					this.Page.Response.Redirect($"/{HiContext.Current.GetClientPath}/MemberCenter");
				}
				if (!user.IsReferral())
				{
				...
				this.hdLink.Value = Globals.FullPath($"/{HiContext.Current.GetClientPath}/ReferralCenter");
