...
{
	[ParseChildren(true)]
	public class AppSplittinDetails : AppshopMemberTemplatedWebControl
	{
		private FormatedMoneyLabel litSplittinDraws;

		private FormatedMoneyLabel litAllSplittin;

		private AppshopTemplatedRepeater rptSplittin;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSplittin = (AppshopTemplatedRepeater)this.FindControl("rptSplittin");
