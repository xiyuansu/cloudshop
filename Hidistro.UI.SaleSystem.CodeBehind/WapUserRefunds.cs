...
{
	[ParseChildren(true)]
	public class WapUserRefunds : WAPMemberTemplatedWebControl
	{
		private WapTemplatedRepeater rptUserRefunds;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptUserRefunds = (WapTemplatedRepeater)this.FindControl("rptUserRefunds");
