...
{
	[ParseChildren(true)]
	public class AppSubReferrals : AppshopMemberTemplatedWebControl
	{
		private AppshopTemplatedRepeater rptSubReferrals;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSubReferrals = (AppshopTemplatedRepeater)this.FindControl("rptSubReferrals");
