...
{
	[ParseChildren(true)]
	public class AppSubMembers : AppshopMemberTemplatedWebControl
	{
		private AppshopTemplatedRepeater rptSubMembers;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSubMembers = (AppshopTemplatedRepeater)this.FindControl("rptSubMembers");
