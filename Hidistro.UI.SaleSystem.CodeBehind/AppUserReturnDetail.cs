...
{
	[ParseChildren(true)]
	public class AppUserReturnDetail : AppshopMemberTemplatedWebControl
	{
		...
		private string credentialsImgHtml = "<a href=\"{0}\" class=\"preview\"><img src=\"/Admin/PicRar.aspx?P={0}&W=50&H=50\"/></a>";
