...
{
	public class WapOrderStoresSet : WAPMemberTemplatedWebControl
	{
		...
		private WapTemplatedRepeater rptStores;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptStores = (WapTemplatedRepeater)this.FindControl("rptStores");
