...
{
	[PrivilegeCheck(Privilege.WeChatFansInteractiveAnalysis)]
	public class WXFansInteractReport : AdminPage
	{
		...
		{
			if (HiContext.Current.SiteSettings.IsInitWXFansInteractData)
			{
